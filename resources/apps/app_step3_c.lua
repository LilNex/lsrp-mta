--MAXIME
local guiStep3 = {}
local info = "تم فتح التقديم الخاص بك وهو قيد المراجعه..\nPlالرجاء الانتضار!"
function startStep3(infoFromServer)
	...
	guiStep3.back = guiCreateButton ( 0.40, 0.81, 0.1, 0.04, "قوانين السيرفر", true)
	guiStep3.retake = guiCreateButton ( 0.5, 0.81, 0.1, 0.04, "تقديم مره اخره", true)
