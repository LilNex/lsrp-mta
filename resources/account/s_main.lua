...
function resourceStart(resource)
	...
	setRuleValue("Author", "Los Santos Roleplay")

	setRuleValue("Email", "LSRP@team")
...
function makeTGName(thePlayer)
	...
	setPlayerName(thePlayer, "LSRP_Player#"..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
