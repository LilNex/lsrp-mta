...
function accessCheck(object)
	...
	if exports.integration:isPlayerScripter(object) then
...
function startListening(player)
	...
	triggerClientEvent(player, "ipb.recStats2", player, 1, stat1, stat2)
...
function changeCategory(newCategory)
	...
	triggerClientEvent(client, "ipb.recStats2", client, 2, stat1, stat2)
