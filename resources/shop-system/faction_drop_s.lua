...
function createForumThread(logs, npcID, npcName, createInForumID)
	...
	for i, record in ipairs(logs) do
		fContent = fContent.."[BR][/BR][BR][/BR][B]Purchase #"..i.."[/B][INDENT]Item Name:   [B]"..tostring(record[5]).." [/B](Serial: "..(record[8] and record[8] or "N/A")..")[/INDENT] [INDENT]Item Cost:      [B]$"..tostring(record[7]).."[/B][/INDENT] [INDENT]Item Value:   [B]"..tostring(record[6]).."[/B][/INDENT] [INDENT]Quantity:        [B]1[/B][/INDENT] [BR][/BR][B]Buyer Information[/B][INDENT] Username:      [B]"..tostring(record[2]).."[/B][/INDENT] [INDENT]Character:       [B]"..tostring(record[3]).."[/B][/INDENT] [INDENT] Faction:            [B]"..tostring(record[4]).."[/B] [/INDENT] [B]Reason:[/B][INDENT]"..tostring(record[9]).." [/INDENT] [B]Issue date:  [/B][INDENT]"..tostring(record[1]).."   [/INDENT] [HR][/HR]"
	end
	
	local content = "[CENTER][IMG]http://owlgaming.net/wp-content/uploads/2014/01/OwlLogo4.png[/IMG][/CENTER][CENTER][INDENT][/INDENT][SIZE=5][FONT=impact]"..fTitle.."[/FONT][/SIZE][/CENTER]"..fContent
	...
	exports.global:sendWrnToStaff(tostring(#logs).." items were purchased from NPC "..tostring(npcName).." (ID #"..tostring(npcID)..")"..". Details at http://forums.owlgaming.net/showthread.php/"..seccondID, "NPC")	
