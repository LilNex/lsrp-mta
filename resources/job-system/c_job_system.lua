...
-- local jessie = createPed( 141, 1533.380859375, 1485.2685546875, 16.953544616699 )
...
function showEmploymentWindow()
	...
	guiGridListSetItemText(jobList, row, column, "Barman", false, false)
	...
	if (button=="left") then
		...
		elseif (job>0) then
			...
			elseif (jobtext=="Locksmith") then
				...
				job = 6
			elseif (jobtext=="Barman") then

				job = 11

			elseif  (jobtext=="Pizza Boy") then

				job = 8
	   exports.under_info:showBox("Go to pizza stacks and enter a bike to start.", "info")
	   exports.under_info:showBox("Congratulations, You're now a Pizza boy.", "info")
