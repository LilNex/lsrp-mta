...
local fishItem = 273
local FishType = {
    [1] = {fishname = "Sardine", fishweight = 0.5, zone = 1},
    [2] = {fishname = "Starry Flounder", fishweight = 11, zone = 1},
    [3] = {fishname = "Calamar", fishweight = 1, zone = 1},
    [4] = {fishname = "Sepia", fishweight = 0.6, zone = 1},
    [5] = {fishname = "Crevette", fishweight = 0.1, zone = 1},
...
function takeDoud(ThePlayer)
    items:takeItem(ThePlayer, 10026)
end
...
function GenerateFishPayment(ThePlayer)
    ...
    if not exports.global:hasItem(ThePlayer, 10025) then
 
		--return exports["SCR_Notifs"]:show_box(ThePlayer,"You don't have Fish Card to sell here ","error")
               return exports.SCR_Info:addNotification(ThePlayer,"You don't have Fish Card to sell here ","info")
		else 
		if not (fishininventory > 0) then
			return exports.SCR_Info:addNotification(ThePlayer,"You don't have any fish to sell ","info")
		end
    end
    ...
    --Generate a price 
    local perFishCost = math.random(50, 100)
...
function sellTheFish(ThePlayer, price)
    ...
    --exports.global:sendLocalText(ThePlayer, "[English] Fisherman John says: Kaayn! Hak Albatal wa7ed flisat, Thela!", 255, 255, 255, 10)
	exports.SCR_Info:addNotification(ThePlayer,"Thanks for the fish, See you next time sir ","info")
...
addEvent("fishing:takeDoud", true)
...
addEventHandler("fishing:takeDoud", root, takeDoud)
