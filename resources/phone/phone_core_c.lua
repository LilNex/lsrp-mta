...
function drawPhoneGUI()
	...
	local label = guiCreateLabel(30,62,300,30,scriptVersion,false,wPhoneMenu)
	guiSetFont(label, "default-small")
	guiSetAlpha(label, 0.2)
...
function powerOnPhone()
	if isPhoneGUICreated() then
		...
		alphaTmp = nil
		powerOnPhone_logo = guiCreateStaticImage(30, 200, rawW, rawH, "images/samsung.png", false, wPhoneMenu)
