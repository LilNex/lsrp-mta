...
function drawSettings(xoffset, yoffset)
    ...
    local smallLine = 14
    yoffset = yoffset + 3
    settingGuis[2] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Phone information: "..scriptVersion, false, settingGuis.main)
    guiSetFont(settingGuis[2], "default-small")

    yoffset = yoffset + smallLine
    settingGuis[3] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Carrier: Los Santos Network", false, settingGuis.main)
    ...
    yoffset = yoffset + smallLine
    settingGuis[15] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine+3, "Create new tone:", false, settingGuis.main)
    ...
    settingGuis[17] = guiCreateButton(20+190-smallLine*2+xoffset, 30+yoffset, smallLine*2, smallLine+3, "Set", false, settingGuis.main)
