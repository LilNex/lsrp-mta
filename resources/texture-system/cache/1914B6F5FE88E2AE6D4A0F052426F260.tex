...
<link rel="alternate" type="application/json+oembed" href="https://registry.co.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fregistry.co.com%2F" />
<link rel="alternate" type="text/xml+oembed" href="https://registry.co.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fregistry.co.com%2F&#038;format=xml" />
...
<div class='full-container'>
    ...
    <div class='co-jumbotron margin-top-40' id='selling-points'>
        <div class='container'>
    ...
    <div class='co-jumbotron' id='sunrise-launch-schedule'>
        <div class='container'>
...
co.com LLC, announced today that Legal Brand Marketing, LLC has acquired a premium portfolio of law-related .co.com domain names, including...</p>
    ...
    (function () {
        $('.carousel').carousel({
            ...
            setTimeout(function () {
                $('.carousel .item .animate-this').removeClass('enter');
            }, 100);
        }).on("slid.bs.carousel", function (e) {
            setTimeout(function () {
                $('.carousel .item.active .animate-this').addClass('enter');
            }, 100);
        }).on('click', '.co-carousel-control.left', function () {
            $('.carousel').carousel('prev');
        }).on('click', '.co-carousel-control.right', function () {
        ...
        $('.point-col').on('mouseover', function() {
            var h, $el = $(this);
            if (!$el.hasClass('active')) {
                $el.addClass('active');
                $el.siblings().removeClass('active').css('margin-bottom', 0);

                h = $el.find('div.desc-container').height() + 20;
                $el.css('margin-bottom', h + 'px')

            }
            $el = h = null;
        });
        $('.point-col').first().trigger('mouseover');
...
-->
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-6 text-left'>
                    Copyright 2021 | co.com LLC<br><a href='/become-a-registrar'>Become a Registrar</a> | <a href='/policy'>Policy</a> | <a href='/about'>About Us</a> | <a href='http://whois.co.com'>Whois</a> | <a href='/contact'>Report Abuse</a>
                </div>
	...
	<script type='text/javascript'>
/* <![CDATA[ */
var wpcf7 = {"apiSettings":{"root":"https:\/\/registry.co.com\/wp-json\/contact-form-7\/v1","namespace":"contact-form-7\/v1"}};
/* ]]> */
</script>
<script type='text/javascript' src='https://registry.co.com/wp-content/plugins/contact-form-7/includes/js/scripts.js?ver=5.1.1'></script>
<script type='text/javascript'>
		...
		holder.innerHTML = '';
         ...
         (function(frm){
            ...
            var holderId = grecaptcha.render(holder,{
                'sitekey': '6Ldz4YUUAAAAAB7ZVTzFCLj5y2pbGNOeyAruyu4t', 'size': 'invisible', 'badge' : 'inline',
...
<script type='text/javascript' src='https://registry.co.com/wp-includes/js/wp-embed.min.js?ver=0bf54fa328d90d5cbb9df7c9ff4b8651'></script>
