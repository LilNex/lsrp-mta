...
WARNING! This c_pilotmission is COMPILED on live server. Make sure you re-compile this file and overwrite the one on git/server if you edit it.
...
function start_GUI(thePlayer, commandName)
	...
	if exports.factions:isPlayerFactionLeader(getLocalPlayer(), 47) then
