...
addEventHandler("onResourceStart", resourceRoot,
	function()
		...
		local ped = createPed(98, 1991.9143066406, -2232.1206054688, 14.40781211853)
		setElementFrozen(ped, true)
		setElementRotation(ped, 0, 0, 7)
...
function doQuery(thetype, info, client, amount)
	if thetype == 1 then
		exports.mysql:query_free("INSERT INTO owl_mta.`sfia_pilots` SET `charactername`='"..exports.mysql:escape_string(info).."'")
	elseif thetype == 2 then
		exports.mysql:query_free("DELETE FROM owl_mta.`sfia_pilots` WHERE `charactername`='"..exports.mysql:escape_string(info).."'")
