				...
				if isOpen then
					...
					if inside then
						if bridge then
							...
							local teleportArr = {gates[gateID][7][1], gates[gateID][7][2], gates[gateID][7][3], 0, 0}
							triggerClientEvent(thePlayer, "setPlayerInsideInterior", thePlayer, teleportArr, 0)
						end
					else
						if not bridge then
							local teleportArr = {gates[gateID][6][1], gates[gateID][6][2], gates[gateID][6][3], gates[gateID][6][4], gates[gateID][6][5]}
							triggerClientEvent(thePlayer, "setPlayerInsideInterior", thePlayer, teleportArr, 0)
						end					
					end
				else
...
function getDataForExitingConnectedPlane(gateID, plane)
	...
	if connected and connected == plane then
		return {gates[gateID][6][1], gates[gateID][6][2], gates[gateID][6][3], gates[gateID][6][4], gates[gateID][6][5]}
	end
	return false
end
