...
local atmPed = createPed( 113, 1121.8330078125, -1117.1298828125, 24.606163024902 )
setPedRotation( atmPed, 180.0439453125 )
setElementDimension( atmPed, 0)
setElementInterior( atmPed , 0 )
setElementData( atmPed, "talk", 1, false )
setElementData( atmPed, "name", "Inactive Bot", false )
...
--GENERAL SERVICE PED
local localPlayer = getLocalPlayer()
local generalServicePed = createPed( 290, 1111.072265625, -1116.615234375, 24.606163024902 )
setPedRotation( generalServicePed,  178.16528320312 )
