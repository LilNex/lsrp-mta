...
local function playGunfireSound(weaponID)
	...
	elseif weaponID == 24 then--deagle
		...
		if mode == 0 then
			...
			sound = playSound3D("sounds/weap/Deagle.mp3", muzzleX, muzzleY, muzzleZ, false)
			setSoundVolume(sound, 0.3)
		end
	...
	elseif weaponID == 25 then--shotgun
		...
		if mode == 0 then
			sound = playSound3D("sounds/weap/beanbag.mp3", muzzleX, muzzleY, muzzleZ, false)
		else
			sound = playSound3D("sounds/weap/Shotgun.mp3", muzzleX, muzzleY, muzzleZ, false)
			setSoundVolume(sound, 0.3)
		end
		setSoundMaxDistance(sound, 120)
		setElementDimension(sound, dim)
