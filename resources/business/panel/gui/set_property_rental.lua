...
function setPropertyRental()
	GUIEditor.window[2] = guiCreateWindow(897, 219, 284, 193, "Rent Property: 3, Cornerbrook St.", false)
	...
	GUIEditor.button[16] = guiCreateButton(11, 109, 263, 32, "Rent Property", false, GUIEditor.window[2])
