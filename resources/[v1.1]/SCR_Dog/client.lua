...
local DogPanelKey = "F5" --Default F6

local ChangeStatusKey = "U" --Default P

local DoTrickKey = "H" --Default O

local Language = "English" --English/German 

local EnableCheats = true --Default false
...
elseif(DMDogRace == 293 or DMDogRace == 294 or DMDogRace == 199 or DMDogRace == 296)then
...
dxDrawText("Criar Cachorro", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMDogCreationColorR, DMDogCreationColorG, DMDogCreationColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")



dxDrawText("Nome dele", 0.785 * DMScreenx, 0.34 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "left", "center")
...
dxDrawText("Raça", 0.785 * DMScreenx, 0.43 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "left", "center")
...
dxDrawText("Cor do cão", 0.785 * DMScreenx, 0.52 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "left", "center")
...
DMFurColorText = "Preto"

elseif(DMDogRace == 291)then

DMFurColorText = "Preto & Branco"

elseif(DMDogRace == 292)then

DMFurColorText = "Preto & Castanho"

elseif(DMDogRace == 293)then

DMFurColorText = "Castanho"

elseif(DMDogRace == 294)then

DMFurColorText = "Branco"

elseif(DMDogRace == 199)then

DMFurColorText = "Cinza"
...
dxDrawText("Genero", 0.785 * DMScreenx, 0.61 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "left", "center")
...
dxDrawText("Fim", 0.9 * DMScreenx, 0.675 * DMScreeny, DMScreenx * 0.943, DMScreeny * 0.713, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")
...
dxDrawText("None dele", 0.785 * DMScreenx, 0.34 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "left", "center")
...
outputChatBox("Name to short", 255,0,0)
...
dxDrawText("Painel do seu cachorro", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

dxDrawText("Seu cachorro foi morto", 0.78 * DMScreenx, 0.37 * DMScreeny, 0.95 * DMScreenx, 0.37 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Revivendo em : "..(180 - DMDogDeathTimerCount).." segundos", 0.78 * DMScreenx, 0.395 * DMScreeny,0.95 * DMScreenx, 0.395 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex * 1.2, DMTextSizey * 1.2, "default-bold", "center", "center")
...
dxDrawText("Estatisticas:", 0.785 * DMScreenx, 0.42 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

if(DMClientDogGender == "male")then

dxDrawText("Velocidade:  #33CCFF"..DMHealth.."#FFFFFF / 100", 0.79 * DMScreenx, 0.445 * DMScreeny, nil, nil, tocolor(255, 225, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center",nil,nil,nil,true)

elseif(DMClientDogGender == "female")then

dxDrawText("Velocidade:  #FF33CC"..DMHealth.."#FFFFFF / 100", 0.79 * DMScreenx, 0.445 * DMScreeny, nil, nil, tocolor(255, 225, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center",nil,nil,nil,true)

end

if(DMClientDogGender == "male")then

dxDrawText("Força:  #33CCFF"..DMClientDogStrength.."#FFFFFF / 100", 0.79 * DMScreenx, 0.465 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center",nil,nil,nil,true)

elseif(DMClientDogGender == "female")then

dxDrawText("Força:  #FF33CC"..DMClientDogStrength.."#FFFFFF / 100", 0.79 * DMScreenx, 0.465 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center",nil,nil,nil,true)

end



dxDrawText("Inventario:", 0.785 * DMScreenx, 0.505 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

dxDrawText("Bola", 0.79 * DMScreenx, 0.53 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

dxDrawText("Comida", 0.79 * DMScreenx, 0.55 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Usar", 0.92 * DMScreenx, 0.52 * DMScreeny, 0.941 * DMScreenx, 0.535 * DMScreeny, tocolor(0, 0, 0, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "center")

dxDrawText("Usar", 0.92 * DMScreenx, 0.54 * DMScreeny, 0.941 * DMScreenx, 0.555 * DMScreeny, tocolor(0, 0, 0, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "center")
...
dxDrawText("Tarefas", 0.844 * DMScreenx, 0.613 * DMScreeny, DMScreenx * 0.885, DMScreeny * 0.653, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")

dxDrawText("Truques", 0.897 * DMScreenx, 0.613 * DMScreeny, DMScreenx * 0.939, DMScreeny * 0.653, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")
...
dxDrawText("Painel cachorro", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(51, 204, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

dxDrawText("", 0.78 * DMScreenx, 0.37 * DMScreeny, 0.95 * DMScreenx, 0.37 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Crie seu cachorro digitando /dog", 0.78 * DMScreenx, 0.395 * DMScreeny,0.95 * DMScreenx, 0.395 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex * 1.2, DMTextSizey * 1.2, "default-bold", "center", "center")
...
outputChatBox("You gave up the fight", 255,255,0)
...
elseif(DMClientDogRace == 293 or DMClientDogRace == 294 or DMClientDogRace == 199 or DMClientDogRace == 296)then
...
dxDrawText("Nome: ", 0.85 * DMScreenx, 0.32 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Vida: ", 0.805 * DMScreenx, 0.39 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Fome: ", 0.805 * DMScreenx, 0.42 * DMScreeny, nil, nil, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
if(DMDogStatus == 1)then
  ...
  dxDrawText("Aguardando", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(0, 255, 51, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

elseif(DMDogStatus == 2)then

  dxDrawText("Te seguindo", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(255, 255, 51, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

elseif(DMDogStatus == 3)then

  dxDrawText("Te protegendo", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(255, 0, 0, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

elseif(DMDogStatus == 4)then

  dxDrawText("Comendo", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

elseif(DMDogStatus == 5)then

  dxDrawText("Brincando", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

elseif(DMDogStatus == 6)then

  dxDrawText("De Guarda", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")

elseif(DMDogStatus == 7)then

  dxDrawText("Lutando", 0.85 * DMScreenx, 0.455 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
outputChatBox("Dog is to far away!",255, 0,0)
...
dxDrawText("Dog Tricks", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Sentar", 0.785 * DMScreenx, 0.33 * DMScreeny, 0.945 * DMScreenx, 0.3785 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

else

dxDrawText("Fechado", 0.785 * DMScreenx, 0.33 * DMScreeny, 0.945 * DMScreenx, 0.3685 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Velocidade 0", 0.785 * DMScreenx, 0.3685 * DMScreeny, 0.945 * DMScreenx, 0.3785 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Fechado", 0.785 * DMScreenx, 0.3785 * DMScreeny, 0.945 * DMScreenx, 0.412 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Velocidade 5", 0.785 * DMScreenx, 0.412 * DMScreeny, 0.945 * DMScreenx, 0.427 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Fechado", 0.785 * DMScreenx, 0.427 * DMScreeny, 0.945 * DMScreenx, 0.4605 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Velocidade 15", 0.785 * DMScreenx, 0.4605 * DMScreeny, 0.945 * DMScreenx, 0.4755 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Jump", 0.785 * DMScreenx, 0.4755 * DMScreeny, 0.945 * DMScreenx, 0.524 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

else

dxDrawText("Fechado", 0.785 * DMScreenx, 0.4755 * DMScreeny, 0.945 * DMScreenx, 0.509 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Velocidade 30", 0.785 * DMScreenx, 0.509 * DMScreeny, 0.945 * DMScreenx, 0.524 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Beg", 0.785 * DMScreenx, 0.524 * DMScreeny, 0.945 * DMScreenx, 0.5725 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

else

dxDrawText("Fechado", 0.785 * DMScreenx, 0.524 * DMScreeny, 0.945 * DMScreenx, 0.5675 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("velocidade 50", 0.785 * DMScreenx, 0.5575 * DMScreeny, 0.945 * DMScreenx, 0.5725 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Fechado", 0.785 * DMScreenx, 0.5725 * DMScreeny, 0.945 * DMScreenx, 0.606 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("velocidade 70", 0.785 * DMScreenx, 0.606 * DMScreeny, 0.945 * DMScreenx, 0.621 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Fechado", 0.785 * DMScreenx, 0.621 * DMScreeny, 0.945 * DMScreenx, 0.6545 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("velocidade 95", 0.785 * DMScreenx, 0.6545 * DMScreeny, 0.945 * DMScreenx, 0.6695 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center")
...
dxDrawText("Esse é o tutorial para fazer truques aperte O  .", 0.45 * DMScreenx, 0.405 * DMScreeny, 0.55 * DMScreenx,  0.5 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default", "center", "center",false, true)

dxDrawText("Clique e segure na  tela", 0.45 * DMScreenx, 0.505 * DMScreeny, 0.55 * DMScreenx,  0.6 * DMScreeny, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "center",false, true)
...
dxDrawText("Mova até o retangulo azul", 0.45 * DMScreenx, 0.45 * DMScreeny, 0.55 * DMScreenx,  0.55 * DMScreeny, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "center")

elseif(DMClientDogGender == "female")then

dxDrawText("Moza até o retangulo rosa", 0.45 * DMScreenx, 0.45 * DMScreeny, 0.55 * DMScreenx,  0.55 * DMScreeny, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "center")
...
outputChatBox("Trick Failed", 255,0,0)
...
function DMthrowBall(button, state)
	...
	DMDogStatus = 5
		...
		if(DMLanguage == 1)then
          ...
          outputChatBox("Your Dog is to far away", 255, 0,0)
		...
		if(DMLanguage == 1)then
          ...
          outputChatBox("Your Dog could not reach the ball", 255, 0,0)
...
dxDrawText("Dog Fight", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Digite o nome do jogador que deseja lutar é uma luta cachorro vs cachorro então a pessoa também tem q ter o vencedor recebe força", 0.785 * DMScreenx, 0.41 * DMScreeny, 0.95 * DMScreenx, 0.47 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "top", false, true)



dxDrawImage(0.9 * DMScreenx, 0.47 * DMScreeny, 80 * DMImagex, 50 * DMImagey, texture5  )

dxDrawText("Fim", 0.9 * DMScreenx, 0.473 * DMScreeny, DMScreenx * 0.942, DMScreeny * 0.513, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")
...
outputChatBox("Não foi possivel encontrar a pessoa", 255, 0,0)
...
outputChatBox("Voce nao pode lutar com vc mesmo", 255,0,0)
...
outputChatBox(getPlayerName(DMDogFightPlayer).." Esta dirigindo", 255,0,0)
...
outputChatBox(getPlayerName(DMDogFightPlayer).." é muito longe", 255,0,0)
...
dxDrawText("Luta de cães", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Quer te perseguir", 0.785 * DMScreenx, 0.42 * DMScreeny, 0.95 * DMScreenx, 0.42 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex* 1.2, DMTextSizey* 1.2, "default-bold", "center", "center")
...
dxDrawText("Aceitar", 0.8 * DMScreenx, 0.463 * DMScreeny, DMScreenx * 0.842, DMScreeny * 0.513, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")

dxDrawText("Recusar", 0.89 * DMScreenx, 0.463 * DMScreeny, DMScreenx * 0.932, DMScreeny * 0.513, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")
...
dxDrawText("Akzeptieren", 0.8 * DMScreenx, 0.463 * DMScreeny, DMScreenx * 0.842, DMScreeny * 0.513, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")

dxDrawText("Ablehnen", 0.89 * DMScreenx, 0.463 * DMScreeny, DMScreenx * 0.932, DMScreeny * 0.513, tocolor(0, 0, 0, 220), DMTextSizex * 0.7, DMTextSizey * 0.7, "beckett", "center", "center")
...
outputChatBox(getPlayerName(DMOpponent).."este player Não tem um cachorro", 255,0,0)
...
outputChatBox(getPlayerName(DMOpponent).." Ja esta em uma briga", 255,0,0)
...
outputChatBox("Pedido de briga enviado", 255 , 255,0)
...
outputChatBox("Dogfight start", 255, 255,0)
...
outputChatBox("Seu pedido foi recusado", 255, 0,0)
...
outputChatBox("Seu cachorro perdeu a luta",255,255,0)
...
outputChatBox("Your Dog won the fight!",0,255,0)
...
outputChatBox(getPlayerName(RequestPlayer).." Desistiu da luta", 0, 255,0)
...
dxDrawText("Sniff Person", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Digite o nome do jogador e seu cão ira achar ele farejando ele sera marcado no mapa", 0.785 * DMScreenx, 0.41 * DMScreeny, 0.94 * DMScreenx, 0.47 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "default-bold", "center", "top", false, true)
...
outputChatBox("Your dog does not smell anything", 255, 0,0)
...
outputChatBox("Found "..getPlayerName(DMDogFightPlayer).."!", 0,255,0)
...
dxDrawText("Tarefas do cachorro", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMTextSizex, DMTextSizey, "default-bold", "left", "center")
...
dxDrawText("Posição de guarda", 0.785 * DMScreenx, 0.33 * DMScreeny, 0.945 * DMScreenx, 0.3785 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Atacar Player", 0.785 * DMScreenx, 0.3785 * DMScreeny, 0.945 * DMScreenx, 0.427 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")

dxDrawText("Farejar Player", 0.785 * DMScreenx, 0.427 * DMScreeny, 0.945 * DMScreenx, 0.4755 * DMScreeny, tocolor(255, 255, 255, 220), DMTextSizex, DMTextSizey, "pricedown", "center", "center")
...
outputChatBox("Dog deleted!", 255, 0,0)
...
outputChatBox("You don't have a dog!", 255, 0,0)
...
outputChatBox("Wait until your dog has eaten!", 255, 0,0)
...
outputChatBox("Wait until your dog has played with the ball", 255, 0,0)
...
dxDrawText("Tutorial do seu cachorro", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center")



dxDrawText("Leia:", 0.785 * DMScreenx, 0.33 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center")

dxDrawText("Esse mod permite que você crie seu cão e ande com ele e use ele leia abaixo os comandos", 0.79 * DMScreenx, 0.36 * DMScreeny, 0.941 * DMScreenx, 0.36 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center",false, true)



dxDrawText("Comandos:", 0.785 * DMScreenx, 0.39 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center")

dxDrawText("/dog - criar seu cachorro", 0.79 * DMScreenx, 0.405 * DMScreeny, 0.941 * DMScreenx, 0.405 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText("/deletedog - deletar seu cachorro", 0.79 * DMScreenx, 0.42 * DMScreeny, 0.941 * DMScreenx, 0.42 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText(DogPanelKey.." - Abrir Painel do seu cão", 0.79 * DMScreenx, 0.435 * DMScreeny, 0.941 * DMScreenx, 0.435 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)



dxDrawText("Açoes:", 0.785 * DMScreenx, 0.45 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center")

dxDrawText(ChangeStatusKey..": Definir status", 0.79 * DMScreenx, 0.465 * DMScreeny, 0.941 * DMScreenx, 0.465 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText(DoTrickKey..": Fazer Truques", 0.79 * DMScreenx, 0.48 * DMScreeny, 0.941 * DMScreenx, 0.48 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText("Guarda: Seu cão fica em posição de guarda", 0.79 * DMScreenx, 0.495 * DMScreeny, 0.941 * DMScreenx, 0.495 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText("Seguir: Seu cão lhe seguira pelo mapa", 0.79 * DMScreenx, 0.51 * DMScreeny, 0.941 * DMScreenx, 0.51 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText("Atacar: Seu cão ira atacar os players que você determinar", 0.79 * DMScreenx, 0.532 * DMScreeny, 0.941 * DMScreenx, 0.532 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true) 



dxDrawText("Estatisticas:", 0.785 * DMScreenx, 0.555 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center")

dxDrawText("Exercicios: Desbloquei truques fazendo caminhadas com seu cão ou correndo", 0.79 * DMScreenx, 0.575 * DMScreeny, 0.941 * DMScreenx, 0.575 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)

dxDrawText("Força: Aumenta o dano do seu cão acostumando ele a atacar ", 0.79 * DMScreenx, 0.605 * DMScreeny, 0.941 * DMScreenx, 0.605 * DMScreeny, tocolor(255, 255, 255, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center", false, true)



dxDrawImage(0.9 * DMScreenx, 0.62 * DMScreeny, 80 * DMImagex, 50 * DMImagey, texture5  )

dxDrawText("Fim", 0.9 * DMScreenx, 0.623 * DMScreeny, DMScreenx * 0.942, DMScreeny * 0.663, tocolor(0, 0, 0, 220), DMHelpTextSizey * 0.7, DMHelpTextSizey * 0.7, "beckett", "center", "center")

elseif(DMLanguage == 2)then

dxDrawRectangle(0.78 * DMScreenx, 0.3 * DMScreeny, 0.17 * DMScreenx, 0.37 * DMScreeny, tocolor(20, 20, 20, 220))

dxDrawText("Ajudar Cão", 0.785 * DMScreenx, 0.315 * DMScreeny, nil, nil, tocolor(DMClientDogGenderColorR, DMClientDogGenderColorG, DMClientDogGenderColorB, 220), DMHelpTextSizey, DMHelpTextSizey, "default-bold", "left", "center")
...
outputChatBox("Despawn your Dog first", 255,0,0)
...
outputChatBox("Cheats are disabled", 255,0,0)
...
addEventHandler("onClientResourceStart", getResourceRootElement(getThisResource()), 
	...
	--PITBULL
      ...
      dff = engineLoadDFF("skins/dff/pitbull1.dff", 199)
	...
	-- load textures
		...
		outputChatBox ( "#00CCFFCachorro #FFFFFFCarregado acesse ele no painel : "..DogPanelKey, 255, 255, 255, true )
