...
function cacheSettings()
	g_Settings = {}
	g_Settings.presetID		= getNumber('presetID',4)
...
addEvent("extaEffect",true)
addEventHandler("extaEffect",root,function(player)
	outputChatBox("test",player)
	triggerEvent( "onClientReady", resourceRoot,player )
