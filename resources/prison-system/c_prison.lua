...
function addPrisonerGUI(source, name, cell, days, hours, charges, row, fines, jailID)
    ...
    if arrestLocation then
        ...
        newPrisonerGUI.label[5] = guiCreateLabel(13, 96, 51, 15, "Hours:", false, newPrisonerGUI.window[1])
        ...
        newPrisonerGUI.label[7] = guiCreateLabel(148, 96, 51, 15, "Minutes:", false, newPrisonerGUI.window[1])
