...
addEventHandler('crusher:show', root,
	function(price)
		...
		guiCreateLabel(20, 15, windowWidth - 40, 16, 'Vous êtes sur le bout de vendre votre voiture au gouvernement (définitivement)!', false, window)
		guiSetFont(guiCreateLabel(40, 40, windowWidth - 40, 16, exports.global:getVehicleName(source), false, window), 'default-bold-small')
		guiSetFont(guiCreateLabel(40, 65, windowWidth - 40, 16, 'ID du véhicule: ' .. tostring(getElementData(source, 'dbid')), false, window), 'default-bold-small')
		guiSetFont(guiCreateLabel(40, 90, windowWidth - 40, 16, 'Prix : $' .. exports.global:formatMoney(price), false, window), 'default-bold-small')

		local accept = guiCreateButton(10, 110, windowWidth / 2 - 15, 40, "Oui, je veux le vendre!", false, window)
		...
		local nope = guiCreateButton(windowWidth / 2 + 5, 110, windowWidth / 2 - 15, 40, "Non, je ne veux pas.", false, window)
...
addEventHandler("onSapphireXMBShow", root, closeWindow )
