...
function aViewMessage ( id )
	...
	if ( aViewMessageForm == nil ) then
		...
		aViewMessageForm	= guiCreateWindow ( x / 2 - 150, y / 2 - 129, 300, 258, "", false )
					   guiCreateLabel ( 0.05, 0.10, 0.30, 0.09, "القسم:", true, aViewMessageForm )
					   guiCreateLabel ( 0.05, 0.18, 0.30, 0.09, "زمن:", true, aViewMessageForm )
					   guiCreateLabel ( 0.05, 0.26, 0.30, 0.09, "الوقت:", true, aViewMessageForm )
		aViewMessageLabelSuspect = guiCreateLabel ( 0.05, 0.34, 0.30, 0.09, "مشتبه فيه:", true, aViewMessageForm )
		aViewMessageSuspect	= guiCreateButton ( 0.40, 0.34, 0.55, 0.07, "عرض المعلومات", true, aViewMessageForm )
		...
		aViewMessageCloseB	= guiCreateButton ( 0.77, 0.86, 0.20, 0.09, "إلغاء", true, aViewMessageForm )
