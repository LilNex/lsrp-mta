...
function displayAdo()
   ...
   --     dxDrawRectangle(467, 311, 171, 15, tocolor(0, 0, 0, 155), false)
     --   dxDrawRectangle(445, 325, 172, 1, tocolor(255, 255, 255, 255), false)
			dxDrawRectangle(posx - (3 + (0.5 * width)),posy - (2 + (infotable[3] * fontHeight)),width + 5,19,tocolor(0,0,0,180))
            dxDrawRectangle(posx - (3 + (0.5 * width)),posy - (2 + (infotable[3] * fontHeight)),width + 2.2,tocolor(255, 255, 255, 255))
