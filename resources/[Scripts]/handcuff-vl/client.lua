	...
	function (dataName, oldValue)
		if dataName == "player.Cuffed" then
			...
			if cuffed then
				...
				exports.bone_attach:attachElementToBone(leftHandCuff[source], source, 11, 0, 0, 0, 90, -45, 0)

				rightHandCuff[source] = createObject(cuffModel, 0, 0, 0)
				setElementDoubleSided(rightHandCuff[source], true)
				exports.bone_attach:attachElementToBone(rightHandCuff[source], source, 12, 0, 0, 0, 90, -45, 0)
