	...
	--local theTeam = getPlayerTeam(thePlayer)
		...
		if not (targetPlayer) then
			...
			if targetPlayer then
				if getElementData(targetPlayer, "dead") == 1 or isPedDead(targetPlayer) then
					...
					--	outputChatBox("You have revived And Take From You 500$", thePlayer, 0, 255, 0)
					exports.global:sendMessageToAdmins("[LSFD]: "..getPlayerName(thePlayer).." mrevived "..tostring(getPlayerName(targetPlayer))..".")
