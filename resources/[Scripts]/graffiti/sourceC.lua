...
addCommandHandler("graffiti",
	function ()
		fID = tonumber(getElementData(localPlayer,"faction"))
		if fID == 94 or fID == 95 or fID == 93 or fID == 1 or fID == 98 or fID == 97 then
			showTheEditor()
		end
	end
)
...
addCommandHandler("gsize",
	function (command, size)
		if tonumber(getElementData(localPlayer,"adminlevel")) > 3 then 
...
addCommandHandler("gclean",
	function ()
		-- if tonumber(getElementData(localPlayer,"adminlevel")) > 0 or getElementData(localPlayer,"faction") == 1 or true  then 
