...
function glueVehicle(attachedTo, x, y, z, rotX, rotY, rotZ)
	...
	exports.logs:logMessage("[/GLUE] " .. getElementData(client, "account:username") .. "/".. getElementData(source, "dbid") .." glued to #".. getElementData(attachedTo, "dbid") .. " - " .. getElementModel(attachedTo), 4)
end
