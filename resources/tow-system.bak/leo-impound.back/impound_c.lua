...
local xImpounder = createPed( 288, 2688.375, -2583.6064453125, 13.6953125 )

setPedRotation( xImpounder, 90 )

setElementDimension( xImpounder, 0)

setElementInterior( xImpounder , 0 )

setElementData( xImpounder, "talk", 1, false )

setElementData( xImpounder, "name", "Alfredo Dolly", false )

setElementFrozen(xImpounder, true)
