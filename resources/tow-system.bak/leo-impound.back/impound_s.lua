...
local impounderCol = {
	...
	[4] = createColCuboid ( 2670.1416015625, -2589.720703125, 11.798411941528, 23, 17, 10 ),
...
function openImpGui(pedName)
	...
	elseif pedName == "Bobby Jones" then
		...
		factionId = 59
	elseif pedName == "Alfredo Dolly" then
...
function leoStartImpounding(dep, vehid, laneNumber, days, fine, first, last, badge, rank, vehName, plate, vin, volations, location, other)
	...
	elseif dep == "SAHP" then
		...
		factionId = 59
	elseif dep == "Rapid Towing" then

		pedName = "Alfredo Dolly"
