...
function payRelease(vehID)
    if exports.global:takeMoney(source, 1000) then
        exports.global:giveMoney(getTeamFromName("Rapid Towing"), 1000)
        exports.mysql:query_free( "INSERT INTO wiretransfers (`from`, `to`, `amount`, `reason`, `type`) VALUES (" .. exports.mysql:escape_string(getElementData(source, "dbid")) .. ", " .. -getElementData(getTeamFromName("Rapid Towing"), "id") .. ", " .. 1000 .. ", 'Vehicle Release', 5)" )
