		...
		for key, value in ipairs(teamPlayers) do
			...
			if vehicleOfficerIsIn then
					...
					--if vehicleFaction and vehicleFaction == 1 or vehicleFaction == 2 then
						...
						if getElementData(theVehicle, "registered") == 1 and getElementData(theVehicle, "show_plate") == 1 and exports['vehicle-system']:hasVehiclePlates( theVehicle ) then
							outputChatBox("[RADIO] The plates are '"..  getVehiclePlateText ( theVehicle ) .."' and the vehicle was heading " .. direction .. ".", value, 0, 210, 255)
						elseif getElementData(theVehicle, "registered") == 0 and getElementData(theVehicle, "show_plate") == 1 and exports['vehicle-system']:hasVehiclePlates( theVehicle ) then
