...
function loadAccountData( accountID )
	if accountID then
		local data = exports.mysql:query_fetch_assoc( "SELECT username, UNIX_TIMESTAMP(lastlogin) AS time, friendsmessage FROM accounts WHERE id = " .. exports.mysql:escape_string( accountID ) )
		if data then
