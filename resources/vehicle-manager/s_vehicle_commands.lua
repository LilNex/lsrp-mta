...
function fixPlayerVehicle(thePlayer, commandName, target)
	...
	if (exports.integration:isPlayerLeadAdmin(thePlayer)  or exports.integration:isPlayerScripter(thePlayer) or exports.integration:isPlayerVehicleConsultant(thePlayer)) then
...
function fuelPlayerVehicle(thePlayer, commandName, target, amount)
	...
	if (exports.integration:isPlayerLeadAdmin(thePlayer)) or (getElementData(getPlayerTeam(localPlayer), "type")) == 7 then 
...
function setVehTint(admin, command, target, status)
	...
	if exports.integration:isPlayerTrialAdmin(admin) or exports.donators:hasPlayerPerk(admin, 16) then
		...
		if not (dbid) then
			...
			if theVehicle then
				...
				if (dbid<0) then -- TEMP vehicle
					...
					if (exports.integration:isPlayerTrialAdmin(thePlayer)) or (exports.donators:hasPlayerPerk(thePlayer, 16) and exports.integration:isPlayerTrialAdmin(thePlayer)) then
