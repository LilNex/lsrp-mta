...
function dropItem(itemID, x, y, z, ammo, keepammo)
	...
	if not ammo then
		...
		if itemID == 60 or itemID == 137 or itemID == 138 or itemID == 175 or itemID == 216 and not exports.integration:isPlayerAdmin(source) then
	...
	triggerClientEvent( source, "finishItemDrop", source )
	exports.global:giveDirtyMoney(source , 0)
end
