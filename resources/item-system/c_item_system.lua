...
--function useItem(button)
	...
	if itemSlot > 0 then -- ITEMS
		...
		elseif (itemID==34) then -- COCAINE
			doDrug1Effect()
			triggerServerEvent("useItem", localPlayer, itemSlot, additional)
		elseif (itemID==555) then -- COCAINE
			triggerEvent("drg:meth",localPlayer)
			triggerServerEvent("useItem", localPlayer, itemSlot, additional)
		...
		elseif (itemID==36) then
			-- triggerServerEvent("extaEffect",root,localPlayer)
			doDrug3Effect()
			triggerServerEvent("useItem", localPlayer, itemSlot, additional)
		...
		elseif (itemID==58) then
			...
			triggerServerEvent("useItem", localPlayer, itemSlot, additional)
			triggerServerEvent("addDrunkness",localPlayer,0.2)
			triggerEvent("alcoholEffect",localPlayer)
		elseif (itemID==62) then
			...
			-- )
			triggerServerEvent("useItem", localPlayer, itemSlot, additional)
			triggerServerEvent("addDrunkness",localPlayer,0.4)
			triggerEvent("alcoholEffect",localPlayer)
		elseif (itemID==63) then
			triggerServerEvent("nx:addBottle", localPlayer, localPlayer)

			triggerServerEvent("useItem", localPlayer, itemSlot, additional)
			-- triggerServerEvent("addDrunkness",localPlayer,0.5)
			triggerEvent("alcoholEffect",localPlayer)
			-- setTimer(
			-- 	function()
