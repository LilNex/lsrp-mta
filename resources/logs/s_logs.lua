...
function dbLog(logSource, actionID, affected, data)
	...
	-- exports.mysql:lazyQuery("INSERT INTO `owl_logs` VALUES ('"..timeString.."', '".. exports.mysql:escape_string(tostring(actionStr) or "") .."', '".. exports.mysql:escape_string(tostring(sourceStr) or "").."', '".. exports.mysql:escape_string(tostring(affectedStr) or "").."', '".. exports.mysql:escape_string(tostring(data) or "").."')")
	-- outputChatBox("Time: '"..timeString.."' | ActionID : '".. exports.mysql:escape_string(tostring(actionStr) or "") .."' | Source : '".. exports.mysql:escape_string(tostring(sourceStr) or "").."' | Affected : '".. exports.mysql:escape_string(tostring(affectedStr) or "").."' | Data : '".. exports.mysql:escape_string(tostring(data) or "").."'", root)
	-- exports.webhooker:sendLogsDiscord("  Time: '"..timeString.."'  |  ActionID: '"..tostring(actionStr) .."'  |  Source: '"..tostring(sourceStr).."'  |  Affected: '"..tostring(affectedStr).."'  |  Data: '"..tostring(data).."'")
	--[[local timeString = ("%04d-%02d-%02d %02d:%02d:%02d"):format(r.year+1900, r.month + 1, r.monthday, r.hour,r.minute, r.second)
	exports.mysql:lazyQuery("INSERT INTO `logtable` VALUES ('"..timeString.."', '".. exports.mysql:escape_string(actionStr) .."', '".. exports.mysql:escape_string(sourceStr).."', '".. exports.mysql:escape_string(affectedStr).."', '".. exports.mysql:escape_string(data).."')") -- you should have used here query_free!!!]]
	return true
end
...
function getElementLogID( theElement )
	if isElement(theElement) then
		...
		if (elementType == 'player') then
			local dbid = getPlayerName(theElement)
			if dbid then
				return tostring(dbid).."#"..tostring(getElementData(theElement,"dbid"))
			end
