...
function www_lses_gov_members()
	...
	local header_label = guiCreateLabel(15,38,122,16,"Our Members",false,bg)
	...
	local header_1 = guiCreateLabel(131,70,200,16,"Chief",false,bg)
	local para1 = guiCreateLabel(128,94,329,70,"We are proud to have TOM STEWART as our chief. He is one of the kindest people you will meet! ",false,bg) 
	...
	local header_2 = guiCreateLabel(131,170,200,16,"Deputy Chief.",false,bg)
	local para2 = guiCreateLabel(128,194,329,70,"JOHN BRENKLY, Medically trained and planning events for the whole community! ",false,bg) 
	...
	local header_3 = guiCreateLabel(131,270,200,16,"The Departments.",false,bg)
	local para3 = guiCreateLabel(128,294,329,70,"Obviously, without these guys, we'd be noone. ",false,bg) 
