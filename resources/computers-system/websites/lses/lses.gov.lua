...
function www_lses_gov()
	...
	local header_label = guiCreateLabel(15,38,122,16,"Home Page",false,bg)
	...
	local header_1 = guiCreateLabel(131,70,200,16,"Welcome...",false,bg)
	...
	local header_2 = guiCreateLabel(131,170,200,16,"Who and What?",false,bg)
	...
	local header_3 = guiCreateLabel(131,270,200,16,"Where?",false,bg)
	local para3 = guiCreateLabel(128,294,329,70,"We can normally be found obviously at the Hospital and Fire Department, situated in Market. ",false,bg) 
