...
function offlineJailPlayer(thePlayer, commandName, who, minutes, ...)
	if (exports.integration:isPlayerTrialAdmin(thePlayer)) then
		...
		if not (who) or not (minutes) or not (...) or (minutes<1) then
			...
			exports.announcement:makePlayerNotification(accountID, "You were given a jail sentence by "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." while being offline.", "Reason: "..reason)
		end
	end
end
