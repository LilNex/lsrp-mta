	...
	if exports.integration:isPlayerTrialAdmin(thePlayer) then
		if not (targetUsername) or not (hours) or (tonumber(hours)<0) or not (...) then
			...
			if string.lower(commandName) == "soban" then
				exports.global:sendMessageToAdmins("[OFFLINE-BAN]: " .. adminTitle .. " silently banned " .. targetUsername .. ". (" .. hours .. ")")
				exports.global:sendMessageToAdmins("[OFFLINE-BAN]: Reason: " .. reason .. ".")
			else
				outputChatBox("[OFFLINE-BAN]: " .. adminTitle .. " banned " .. targetUsername .. ". (" .. hours .. ")", getRootElement(), 255, 0, 51)
