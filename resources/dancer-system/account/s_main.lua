...
function makeIName(thePlayer)
	setPlayerName(thePlayer, "AMG."..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
end