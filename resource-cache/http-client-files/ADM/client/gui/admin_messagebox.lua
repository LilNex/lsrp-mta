...
function aMessageBox ( type, message, action, vOne, vTwo, vThree )
	...
	if ( aMessageForm == nil ) then
		...
		aMessageYes		= guiCreateButton ( 120, 70, 55, 17, "نعم", false, aMessageForm )
		aMessageNo		= guiCreateButton ( 180, 70, 55, 17, "لا", false, aMessageForm )
		aMessageOk		= guiCreateButton ( 160, 70, 55, 17, "موافق", false, aMessageForm )
