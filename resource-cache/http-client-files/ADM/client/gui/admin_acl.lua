...
function aManageACL ()
	if ( aAclForm == nil ) then
		...
		aAclForm		= guiCreateWindow ( x / 2 - 230, y / 2 - 250, 460, 500, "اعدادات ACL العامة", false )
		...
		aACLCreateGroup	= guiCreateButton ( 0.55, 0.05, 0.40, 0.04, "إنشاء قروب", true, aAclForm )
		aACLCreateACL		= guiCreateButton ( 0.55, 0.10, 0.40, 0.04, "إنشاء ملف ACL", true, aAclForm )
		...
		aACLDestroyGroup	= guiCreateButton ( 0.55, 0.25, 0.40, 0.04, "حذف قروب", true, aAclForm )
		aACLDestroyACL	= guiCreateButton ( 0.55, 0.25, 0.40, 0.04, "حذف ACL", true, aAclForm )
		aACLAddObject		= guiCreateButton ( 0.55, 0.30, 0.40, 0.04, "إضافة إسم", true, aAclForm )
		aACLRemoveObject	= guiCreateButton ( 0.55, 0.35, 0.40, 0.04, "حذف إسم", true, aAclForm )
		aACLAddACL		= guiCreateButton ( 0.55, 0.40, 0.40, 0.04, "إضافة ACL", true, aAclForm )
		aACLRemoveACL	= guiCreateButton ( 0.55, 0.45, 0.40, 0.04, "حذف ACL", true, aAclForm )
		...
		aACLOk		= guiCreateButton ( 0.55, 0.40, 0.19, 0.04, "موافق", true, aAclForm )
		aACLCancel		= guiCreateButton ( 0.76, 0.40, 0.19, 0.04, "إلغاء", true, aAclForm )

		aACLAddRight		= guiCreateButton ( 0.55, 0.30, 0.40, 0.04, "اضافة أمر", true, aAclForm )
		aACLExit		= guiCreateButton ( 0.75, 0.90, 0.27, 0.04, "خروج", true, aAclForm )
		aclDisplayOptions ( "", "" )
