...
function aViewModdetails ( player )
	...
	if ( aModdetailsForm == nil ) then
		...
		aModdetailsForm	= guiCreateWindow ( x / 2 - 250, y / 2 - 125, 350, 350, "عرض تفاصيل", false )
		...
		aModdetailsRefresh	= guiCreateButton ( 0.76, 0.78, 0.32, 0.05, "تحديث", true, aModdetailsForm )
		aModdetailsClose	= guiCreateButton ( 0.76, 0.85, 0.32, 0.05, "قريب", true, aModdetailsForm )
	...
	guiSetText( aModdetailsForm, "تفاصيل التعديل: '" .. tostring(getPlayerName(modDetailsPlayer)) .."'" )
	aHideFloaters()
