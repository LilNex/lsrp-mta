...
function aAdminMenu ()
	if ( aAdminForm == nil ) then
		...
		aAdminForm			= guiCreateWindow ( x / 2 - 310, y / 2 - 260, 620, 520, "", false )
						  ...
						  guiSetText ( aAdminForm, "لوحة الادمنيه   -   v".._version )
						  guiCreateLabel ( 0.81, 0.06, 0.45, 0.04, "admin-ar", true, aAdminForm )
		aTabPanel			= guiCreateTabPanel ( 0.01, 0.05, 0.98, 0.95, true, aAdminForm )
		aTab1 = {}
		aTab1.Tab			= guiCreateTab ( "اللاعبين", aTabPanel, "players" )
		aTab1.Messages		= guiCreateButton ( 0.75, 0.02, 0.23, 0.04, "0/0 رسائل غير مقروءة", true, aTab1.Tab )
		aTab1.ScreenShots		= guiCreateButton ( 0.75, 0.065, 0.23, 0.04, "لقطات مسجلة", true, aTab1.Tab )
		...
		aTab1.HideColorCodes= guiCreateCheckBox ( 0.037, 0.94, 0.20, 0.04, "إخفاء اكواد الآلوان", true, true, aTab1.Tab )
		aTab1.PlayerList		= guiCreateGridList ( 0.03, 0.10, 0.20, 0.83, true, aTab1.Tab )
						  guiGridListAddColumn( aTab1.PlayerList, "اسم اللاعب", 0.85 )
		...
		aTab1.Kick			= guiCreateButton ( 0.71, 0.125, 0.13, 0.04, "طرد", true, aTab1.Tab, "kick" )
		aTab1.Ban			= guiCreateButton ( 0.85, 0.125, 0.13, 0.04, "حظر", true, aTab1.Tab, "ban" )
		aTab1.Mute			= guiCreateButton ( 0.71, 0.170, 0.13, 0.04, "كتم", true, aTab1.Tab, "mute" )
		aTab1.Freeze		= guiCreateButton ( 0.85, 0.170, 0.13, 0.04, "تجميـد", true, aTab1.Tab, "freeze" )
		aTab1.Spectate		= guiCreateButton ( 0.71, 0.215, 0.13, 0.04, "مراقبـه", true, aTab1.Tab, "spectate" )
		aTab1.Slap			= guiCreateButton ( 0.85, 0.215, 0.13, 0.04, "slap"..aCurrentSlap.." -", true, aTab1.Tab, "slap" )
		...
		aTab1.Nick			= guiCreateButton ( 0.71, 0.260, 0.13, 0.04, "تغيير الاسم", true, aTab1.Tab )
		aTab1.Shout			= guiCreateButton ( 0.85, 0.260, 0.13, 0.04, "ارسال تحذير", true, aTab1.Tab, "shout" )
		aTab1.Admin			= guiCreateButton ( 0.71, 0.305, 0.27, 0.04, "إعطائه ادمنيه", true, aTab1.Tab, "setgroup" )

		local y = 0.03		-- Start y coord
		local A = 0.045		-- Large line gap
		local B = 0.035		-- Small line gap

						     guiCreateHeader ( 0.25, y, 0.20, 0.04, "اللاعب:", true, aTab1.Tab )
y=y+A   aTab1.Name			= guiCreateLabel ( 0.26, y, 0.30, 0.035, "الأسم: غير معروف", true, aTab1.Tab )
y=y+A   aTab1.IP			= guiCreateLabel ( 0.26, y, 0.30, 0.035, "الاي بي: غير معروف", true, aTab1.Tab )
...
y=y+A   aTab1.Serial		= guiCreateLabel ( 0.26, y, 0.435, 0.035, "الرقم التسلسلي: غير معروف", true, aTab1.Tab )
		--aTab1.Username		= guiCreateLabel ( 0.26, 0.245, 0.435, 0.035, "Username: N/A", true, aTab1.Tab )
y=y+B   aTab1.Version		= guiCreateLabel ( 0.26, y, 0.435, 0.035, "الاصدار: غير معروف", true, aTab1.Tab )
y=y+B   aTab1.Accountname	= guiCreateLabel ( 0.26, y, 0.435, 0.035, "إسم الحساب: غير معروف", true, aTab1.Tab )
y=y+B   aTab1.Groups		= guiCreateLabel ( 0.26, y, 0.435, 0.035, "المجموعه: غير معروف", true, aTab1.Tab )
y=y+A   aTab1.ACDetected	= guiCreateLabel ( 0.26, y, 0.30, 0.035, "AC # الكشف: غير معروف", true, aTab1.Tab )
y=y+B   aTab1.ACD3D			= guiCreateLabel ( 0.26, y, 0.30, 0.035, "D3D9.DLL : غير معروف", true, aTab1.Tab )
y=y+B   aTab1.ACModInfo		= guiCreateLabel ( 0.26, y, 0.20, 0.035, "GTA تعديل : غير معروف", true, aTab1.Tab )
		aTab1.ACModDetails = guiCreateButton ( 0.46, y, 0.13, 0.04, "تفاصيل", true, aTab1.Tab )


		B = 0.040
y=y+A  				         guiCreateHeader ( 0.25, y, 0.20, 0.04, "اللعبة:", true, aTab1.Tab )
y=y+A   aTab1.Health		= guiCreateLabel ( 0.26, y, 0.20, 0.04, "0 : صحة %", true, aTab1.Tab )
		aTab1.Armour		= guiCreateLabel ( 0.45, y, 0.20, 0.04, "الدرع: 0 %", true, aTab1.Tab )
y=y+B   aTab1.Skin			= guiCreateLabel ( 0.26, y, 0.20, 0.04, "الشخصيه: N/A", true, aTab1.Tab )
		aTab1.Team			= guiCreateLabel ( 0.45, y, 0.20, 0.04, "الفريق : لا يوجد", true, aTab1.Tab )
y=y+B   aTab1.Weapon		= guiCreateLabel ( 0.26, y, 0.35, 0.04, "السلاح: N/A", true, aTab1.Tab )
y=y+B   aTab1.Ping			= guiCreateLabel ( 0.26, y, 0.20, 0.04, "البينغ : 0", true, aTab1.Tab )
		aTab1.Money			= guiCreateLabel ( 0.45, y, 0.20, 0.04, "0 : المال", true, aTab1.Tab )
y=y+B   aTab1.Area			= guiCreateLabel ( 0.26, y, 0.44, 0.04, "منطقة: غير معروف", true, aTab1.Tab )
...
y=y+B   aTab1.Dimension		= guiCreateLabel ( 0.26, y, 0.20, 0.04, "البعد: 0", true, aTab1.Tab )
		aTab1.Interior		= guiCreateLabel ( 0.45, y, 0.20, 0.04, "داخلي : 0", true, aTab1.Tab )

y=y+A  				         guiCreateHeader ( 0.25, y, 0.20, 0.04, "المركبة:", true, aTab1.Tab )
y=y+A  aTab1.Vehicle		= guiCreateLabel ( 0.26, y, 0.35, 0.04, "المركبة: N/A", true, aTab1.Tab )
y=y+B  aTab1.VehicleHealth	= guiCreateLabel ( 0.26, y, 0.25, 0.04, " قوة المركبة : 0 %", true, aTab1.Tab )

		aTab1.SetHealth		= guiCreateButton ( 0.71, 0.395, 0.13, 0.04, "اعطاء دم", true, aTab1.Tab, "sethealth" )
		aTab1.SetArmour		= guiCreateButton ( 0.85, 0.395, 0.13, 0.04, "إعطاء درع", true, aTab1.Tab, "setarmour" )
		aTab1.SetSkin		= guiCreateButton ( 0.71, 0.440, 0.13, 0.04, "تغيير الشخصيه", true, aTab1.Tab, "setskin" )
		aTab1.SetTeam		= guiCreateButton ( 0.85, 0.440, 0.13, 0.04, "تغيير الفريق", true, aTab1.Tab, "setteam" )
		aTab1.SetDimension	= guiCreateButton ( 0.71, 0.755, 0.13, 0.04, "تعيين البعد", true, aTab1.Tab, "setdimension" )
		aTab1.SetInterior		= guiCreateButton ( 0.85, 0.755, 0.13, 0.04, "اختيار المبنى", true, aTab1.Tab, "setinterior" )
		aTab1.GiveWeapon		= guiCreateButton ( 0.71, 0.485, 0.27, 0.04, "إعطاء سلاح: "..getWeaponNameFromID ( aCurrentWeapon ), true, aTab1.Tab, "giveweapon" )
		...
		aTab1.SetMoney		= guiCreateButton ( 0.71, 0.530, 0.13, 0.04, "إعطاء مال", true, aTab1.Tab, "setmoney" )
		aTab1.SetStats		= guiCreateButton ( 0.85, 0.530, 0.13, 0.04, "ادوات", true, aTab1.Tab, "setstat" )
		aTab1.JetPack		= guiCreateButton ( 0.71, 0.575, 0.27, 0.04, "إعطاء نفاثه", true, aTab1.Tab, "jetpack" )
		aTab1.Warp			= guiCreateButton ( 0.71, 0.620, 0.27, 0.04, "الذهاب إلى اللاعب", true, aTab1.Tab, "warp" )
		aTab1.WarpTo		= guiCreateButton ( 0.71, 0.665, 0.27, 0.04, "جلب اللاعب إلى ..", true, aTab1.Tab, "warp" )
		aTab1.VehicleFix		= guiCreateButton ( 0.71, 0.84, 0.13, 0.04, "اصلاح", true, aTab1.Tab, "repair" )
		aTab1.VehicleDestroy	= guiCreateButton ( 0.71, 0.89, 0.13, 0.04, "ازالة", true, aTab1.Tab, "destroyvehicle" )
		aTab1.VehicleBlow		= guiCreateButton ( 0.85, 0.84, 0.13, 0.04, "تفجير", true, aTab1.Tab, "blowvehicle" )
		aTab1.VehicleCustomize 	= guiCreateButton ( 0.85, 0.89, 0.13, 0.04, "اعدادات", true, aTab1.Tab, "customize" )
		aTab1.AnonAdmin		  = guiCreateCheckBox (0.745, 0.942, 0.20, 0.04, "ادمن متخفي", isAnonAdmin(), true, aTab1.Tab )
		aTab1.GiveVehicle		= guiCreateButton ( 0.71, 0.710, 0.27, 0.04, "اعطاء مركبة : "..getVehicleNameFromModel ( aCurrentVehicle ), true, aTab1.Tab, "givevehicle" )
		...
		aTab2 = {}
		aTab2.Tab			= guiCreateTab ( "المودات", aTabPanel, "resources" )
		aTab2.ManageACL		= guiCreateButton ( 0.75, 0.02, 0.23, 0.04, "اعدادات ACL", true, aTab2.Tab )
		...
		aTab2.ResourceList	= guiCreateGridList ( 0.03, 0.10, 0.35, 0.80, true, aTab2.Tab )
						  guiGridListAddColumn( aTab2.ResourceList, "المودات", 0.55 )
						  guiGridListAddColumn( aTab2.ResourceList, "", 0.05 )
						  guiGridListAddColumn( aTab2.ResourceList, "ادوات", 0.35 )
						  guiGridListAddColumn( aTab2.ResourceList, "الاسم الكامل", 0.6 )
						  guiGridListAddColumn( aTab2.ResourceList, "المالك", 0.4 )
						  guiGridListAddColumn( aTab2.ResourceList, "النسخة", 0.2 )
		aTab2.ResourceInclMaps	= guiCreateCheckBox ( 0.03, 0.91, 0.15, 0.04, "اظهار الخرائط", false, true, aTab2.Tab )
		aTab2.ResourceRefresh	= guiCreateButton ( 0.20, 0.915, 0.18, 0.04, "تحديث", true, aTab2.Tab, "listresources" )
		aTab2.ResourceSettings	= guiCreateButton ( 0.40, 0.05, 0.20, 0.04, "إعدادات", true, aTab2.Tab )
		aTab2.ResourceStart	= guiCreateButton ( 0.40, 0.10, 0.20, 0.04, "تشغيل", true, aTab2.Tab, "start" )
		aTab2.ResourceRestart	= guiCreateButton ( 0.40, 0.15, 0.20, 0.04, "إعادة تشغيل", true, aTab2.Tab, "restart" )
		aTab2.ResourceStop	= guiCreateButton ( 0.40, 0.20, 0.20, 0.04, "إيقاف", true, aTab2.Tab, "stop" )
		aTab2.ResourceDelete	= guiCreateButton ( 0.40, 0.25, 0.20, 0.04, "حذف", true, aTab2.Tab, "delete" )
		aTab2.ResourcesStopAll	= guiCreateButton ( 0.63, 0.2, 0.20, 0.04, "ايقاف جميع المودات", true, aTab2.Tab, "stopall" )
		...
		--aModules			= guiCreateTabPanel ( 0.40, 0.25, 0.57, 0.38, true, aTab2.Tab ) --What's that for?
							guiCreateHeader(0.40, 0.3, 0.3, 0.04, "معلومات المود : ", true, aTab2.Tab)
		aTab2.ResourceName			= guiCreateLabel ( 0.41, 0.35, 0.6, 0.03, "الاسم الكامل: ", true, aTab2.Tab )
		aTab2.ResourceAuthor		= guiCreateLabel ( 0.41, 0.4, 0.6, 0.03, "المالك: ", true, aTab2.Tab )
		aTab2.ResourceVersion		= guiCreateLabel ( 0.41, 0.45, 0.6, 0.03, "", true, aTab2.Tab )
		aTab2.ResourceVersion		= guiCreateLabel ( 0.41, 0.45, 0.6, 0.03, "نسخة : ", true, aTab2.Tab )
						  guiCreateLabel ( 0.40, 0.77, 0.20, 0.03, "سجل الاجراءات:", true, aTab2.Tab )
		...
		aTab2.LogLine5		= guiCreateLabel ( 0.41, 0.93, 0.50, 0.03, "", true, aTab2.Tab )
						  guiCreateLabel ( 0.41, 0.65, 0.50, 0.04, "استخراج:", true, aTab2.Tab )
		aTab2.Command		= guiCreateEdit ( 0.41, 0.70, 0.40, 0.055, "", true, aTab2.Tab )
		aTab2.ExecuteClient	= guiCreateButton ( 0.82, 0.70, 0.16, 0.035, "عميل", true, aTab2.Tab, "execute" )
		aTab2.ExecuteServer	= guiCreateButton ( 0.82, 0.736, 0.16, 0.035, "سيرفر", true, aTab2.Tab, "execute" )
		aTab2.ExecuteAdvanced	= guiCreateLabel ( 0.45, 0.71, 0.50, 0.04, "للمستخدمين المتقدمين فقط .", true, aTab2.Tab )
		...
		aTab3 = {}
		aTab3.Tab			= guiCreateTab ( "السيرفر", aTabPanel, "server" )
		aTab3.Server		= guiCreateLabel ( 0.05, 0.05, 0.70, 0.05, "السيرفر : غير معروف", true, aTab3.Tab )
		aTab3.Password		= guiCreateLabel ( 0.05, 0.10, 0.40, 0.05, "كلمة المرور : لا توجد", true, aTab3.Tab )
		aTab3.GameType		= guiCreateLabel ( 0.05, 0.15, 0.40, 0.05, "نوع المود : لا يوجد", true, aTab3.Tab )
		aTab3.MapName		= guiCreateLabel ( 0.05, 0.20, 0.40, 0.05, "اسم الخريطة : لا توجد", true, aTab3.Tab )
		aTab3.Players		= guiCreateLabel ( 0.05, 0.25, 0.20, 0.05, "عدد اللاعبين : 0/0", true, aTab3.Tab )
		aTab3.SetPassword		= guiCreateButton ( 0.80, 0.05, 0.18, 0.04, "وضع كلمة مرور", true, aTab3.Tab, "setpassword" )
		aTab3.ResetPassword	= guiCreateButton ( 0.80, 0.10, 0.18, 0.04, "إزالة كلمة المرور", true, aTab3.Tab, "setpassword" )
		aTab3.SetGameType		= guiCreateButton ( 0.80, 0.15, 0.18, 0.04, "وضع اسم المود", true, aTab3.Tab, "setgame" )
		aTab3.SetMapName		= guiCreateButton ( 0.80, 0.20, 0.18, 0.04, "وضع اسم الخريطة", true, aTab3.Tab, "setmap" )
		aTab3.SetWelcome		= guiCreateButton ( 0.80, 0.25, 0.18, 0.04, "رسالة الترحيب", true, aTab3.Tab, "setwelcome" )
		aTab3.Shutdown		= guiCreateButton ( 0.80, 0.3, 0.18, 0.04, "اطفئ السيرفر", true, aTab3.Tab, "shutdown" )
						  guiCreateStaticImage ( 0.05, 0.32, 0.50, 0.0025, "client\\images\\dot.png", true, aTab3.Tab )
		aTab3.WeatherCurrent	= guiCreateLabel ( 0.05, 0.35, 0.45, 0.05, "الجو الحالي: "..getWeather().." ("..getWeatherNameFromID ( getWeather() )..")", true, aTab3.Tab )
		...
		aTab3.WeatherSet		= guiCreateButton ( 0.50, 0.40, 0.10, 0.04, "وضع", true, aTab3.Tab, "setweather" )
		aTab3.WeatherBlend	= guiCreateButton ( 0.61, 0.40, 0.15, 0.04, "حفظ الجو", true, aTab3.Tab, "blendweather" )

						  local th, tm = getTime()
		aTab3.TimeCurrent		= guiCreateLabel ( 0.05, 0.45, 0.25, 0.04, "الوقت: "..th..":"..tm, true, aTab3.Tab )
		...
		aTab3.TimeSet		= guiCreateButton ( 0.50, 0.45, 0.10, 0.04, "وضع", true, aTab3.Tab, "settime" )
						  guiCreateLabel ( 0.63, 0.45, 0.12, 0.04, "( 0-23:0-59 )", true, aTab3.Tab )

		aTab3.GravityCurrent	= guiCreateLabel ( 0.05, 0.50, 0.28, 0.04, "الجاذبيه: "..string.sub ( getGravity(), 0, 6 ), true, aTab3.Tab )
		aTab3.Gravity		= guiCreateEdit ( 0.35, 0.50, 0.135, 0.04, "0.008", true, aTab3.Tab )
		aTab3.GravitySet		= guiCreateButton ( 0.50, 0.50, 0.10, 0.04, "وضع", true, aTab3.Tab, "setgravity" )

		aTab3.SpeedCurrent	= guiCreateLabel ( 0.05, 0.55, 0.30, 0.04, "سرعة اللعب: "..getGameSpeed(), true, aTab3.Tab )
		aTab3.Speed			= guiCreateEdit ( 0.35, 0.55, 0.135, 0.04, "1", true, aTab3.Tab )
		aTab3.SpeedSet		= guiCreateButton ( 0.50, 0.55, 0.10, 0.04, "وضع", true, aTab3.Tab, "setgamespeed" )
						  guiCreateLabel ( 0.63, 0.55, 0.09, 0.04, "( 0-10 )", true, aTab3.Tab )

		aTab3.WavesCurrent	= guiCreateLabel ( 0.05, 0.60, 0.25, 0.04, "موجات، إرتفاع: "..getWaveHeight(), true, aTab3.Tab )
		aTab3.Waves			= guiCreateEdit ( 0.35, 0.60, 0.135, 0.04, "0", true, aTab3.Tab )
		aTab3.WavesSet		= guiCreateButton ( 0.50, 0.60, 0.10, 0.04, "وضع", true, aTab3.Tab, "setwaveheight" )
		...
		aTab3.FPSSet		= guiCreateButton ( 0.50, 0.65, 0.10, 0.04, "وضع", true, aTab3.Tab, "setfpslimit" )
					 	 guiCreateLabel ( 0.63, 0.65, 0.1, 0.04, "( 25-100 )", true, aTab3.Tab )


		aTab4 = {}
		aTab4.Tab			= guiCreateTab ( "المطرودين", aTabPanel, "bans" )
		aTab4.BansList		= guiCreateGridList ( 0.03, 0.05, 0.80, 0.87, true, aTab4.Tab )
						  guiGridListAddColumn( aTab4.BansList, "الاسم", 0.22 )
						  guiGridListAddColumn( aTab4.BansList, "الأيبي", 0.22 )
						  guiGridListAddColumn( aTab4.BansList, "السيريال", 0.22 )
						  guiGridListAddColumn( aTab4.BansList, "بواسطة", 0.22 )
						  guiGridListAddColumn( aTab4.BansList, "التاريخ", 0.17 )
						  guiGridListAddColumn( aTab4.BansList, "الوقت", 0.13 )
						  guiGridListAddColumn( aTab4.BansList, "تاريخ رفع الحظر", 0.25 )
						  guiGridListAddColumn( aTab4.BansList, "السبب", 0.8 )

						  guiGridListSetSortingEnabled( aTab4.BansList, false )
		aTab4.Details		= guiCreateButton ( 0.85, 0.10, 0.13, 0.04, "معلومات", true, aTab4.Tab )
		aTab4.Unban			= guiCreateButton ( 0.85, 0.20, 0.13, 0.04, "فك الطرد", true, aTab4.Tab, "unban" )
		aTab4.UnbanIP		= guiCreateButton ( 0.85, 0.25, 0.13, 0.04, "فك الاي بي", true, aTab4.Tab, "unbanip" )
		aTab4.UnbanSerial		= guiCreateButton ( 0.85, 0.30, 0.13, 0.04, "فك السريال", true, aTab4.Tab, "unbanserial" )
		aTab4.BanIP			= guiCreateButton ( 0.85, 0.40, 0.13, 0.04, "طرد اي بي", true, aTab4.Tab, "banip" )
		aTab4.BanSerial		= guiCreateButton ( 0.85, 0.45, 0.13, 0.04, "طرد سيريال", true, aTab4.Tab, "banserial" )
		aTab4.BansRefresh		= guiCreateButton ( 0.85, 0.85, 0.13, 0.04, "تحديث", true, aTab4.Tab, "listbans" )

		aTab4.BansTotal		= guiCreateLabel ( 0.20, 0.94, 0.31, 0.04, "عرض 0 / 0 المطرودين", true, aTab4.Tab )
		aTab4.BansMore		= guiCreateButton ( 0.50, 0.94, 0.13, 0.04, "المزيد...", true, aTab4.Tab, "listbans" )

		aTab5 = {}
		aTab5.Tab			= guiCreateTab ( "شات الادمين", aTabPanel, "adminchat" )
		...
		aTab5.AdminPlayers	= guiCreateGridList ( 0.79, 0.05, 0.18, 0.80, true, aTab5.Tab )
						  guiGridListAddColumn ( aTab5.AdminPlayers, "الادمن", 0.90 )
		aTab5.AdminChatSound	= guiCreateCheckBox ( 0.79, 0.86, 0.18, 0.04, "تشغيل الصوت", true, true, aTab5.Tab )
		aTab5.AdminText		= guiCreateEdit ( 0.03, 0.92, 0.80, 0.06, "", true, aTab5.Tab )
		aTab5.AdminSay		= guiCreateButton ( 0.85, 0.92, 0.08, 0.06, "ارسال", true, aTab5.Tab )
		aTab5.AdminChatHelp	= guiCreateButton ( 0.94, 0.92, 0.03, 0.06, "؟", true, aTab5.Tab )

		aTab6 = {}
		aTab6.Tab			= guiCreateTab ( "الإعدادات", aTabPanel )
						  guiCreateHeader ( 0.03, 0.05, 0.10, 0.05, "القائمه:", true, aTab6.Tab )
		aTab6.OutputPlayer	= guiCreateCheckBox ( 0.05, 0.10, 0.47, 0.04, "ضع معلومات الكنسول عند الاختيار", false, true, aTab6.Tab )
						  guiCreateLabel ( 0.08, 0.15, 0.40, 0.04, "هذا قد يفيد في نسخ بيانات اللاعب", true, aTab6.Tab )
		aTab6.AdminChatOutput 	= guiCreateCheckBox ( 0.05, 0.20, 0.47, 0.04, "ضع رسالة الادمن في الدردشه", false, true, aTab6.Tab )
						  guiCreateHeader (  0.03, 0.30, 0.47, 0.04, "المظهر:", true, aTab6.Tab )
						  guiCreateHeader ( 0.63, 0.05, 0.10, 0.05, "الحساب:", true, aTab6.Tab )
		aTab6.AutoLogin		= guiCreateCheckBox ( 0.65, 0.10, 0.47, 0.04, "الدخول بواسطه السريال", false, true, aTab6.Tab )
						  guiSetVisible ( aTab6.AutoLogin, false )	-- Not used
						  guiCreateHeader ( 0.63, 0.15, 0.25, 0.05, "كلمة المرور : ", true, aTab6.Tab )
						  guiCreateLabel ( 0.65, 0.20, 0.15, 0.05, "ك.السر قديمة : ", true, aTab6.Tab )
						  guiCreateLabel ( 0.65, 0.25, 0.15, 0.05, "ك.السر جديدة : ", true, aTab6.Tab )
						  guiCreateLabel ( 0.65, 0.30, 0.15, 0.05, "تكرار ك.السر : ", true, aTab6.Tab )
		...
		aTab6.PasswordChange	= guiCreateButton ( 0.85, 0.35, 0.10, 0.04, "حفظ", true, aTab6.Tab )
						  guiCreateHeader ( 0.03, 0.65, 0.20, 0.055, "الاداء:", true, aTab6.Tab )
						  guiCreateStaticImage ( 0.03, 0.69, 0.94, 0.0025, "client\\images\\dot.png", true, aTab6.Tab )
						  guiCreateLabel ( 0.05, 0.71, 0.20, 0.055, "الاداء:", true, aTab6.Tab )
						  guiCreateLabel ( 0.11, 0.76, 0.10, 0.05, "الذاكره", true, aTab6.Tab )
						  guiCreateLabel ( 0.11, 0.81, 0.10, 0.05, "تلقائي", true, aTab6.Tab )
						  guiCreateLabel ( 0.11, 0.86, 0.10, 0.05, "السرعه", true, aTab6.Tab )
		...
		aTab6.PerformanceAdvanced = guiCreateButton ( 0.05, 0.91, 0.11, 0.04, "متقدم", true, aTab6.Tab )
		aPerformance()
					   	  guiCreateLabel ( 0.70, 0.90, 0.19, 0.055, "تحديث تأخير (م.ث) : ", true, aTab6.Tab )
...
function aAdminRefresh ()
	if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) ~= -1 ) then
		...
		if ( player and aPlayers[player] ) then
			guiSetText ( aTab1.Name, "الإسم: "..aPlayers[player]["name"] )
			guiSetText ( aTab1.Mute, iif ( aPlayers[player]["mute"], "فك", "اسكات" ) )
			guiSetText ( aTab1.Freeze, iif ( aPlayers[player]["freeze"], "فك", "تجميد" ) )
			--guiSetText ( aTab1.Username, "Community Username: "..( aPlayers[player]["username"] or "" ) )
			guiSetText ( aTab1.Version, "الإصدار : "..( aPlayers[player]["version"] or "" ) )
			guiSetText ( aTab1.Accountname, "اسم العضويه : "..( aPlayers[player]["accountname"] or "" ) )
			guiSetText ( aTab1.Groups, "المجموعه : "..( aPlayers[player]["groups"] or "None" ) )
			guiSetText ( aTab1.ACDetected, "الكشف عن AC : "..( aPlayers[player]["acdetected"] or "" ) )
			guiSetText ( aTab1.ACD3D, "D3D9.DLL : "..( aPlayers[player]["d3d9dll"] or "" ) )
			guiSetText ( aTab1.ACModInfo, "GTA تعديل : "..( aPlayers[player]["imgmodsnum"] or "" ) )
			if ( isPedDead ( player ) ) then guiSetText ( aTab1.Health, "Health: Dead" )
			else guiSetText ( aTab1.Health, "الدم : "..math.ceil ( getElementHealth ( player ) ).."%" ) end
			guiSetText ( aTab1.Armour, "الدرع : "..math.ceil ( getPedArmor ( player ) ).."%" )
			guiSetText ( aTab1.Skin, "الشخصيه : "..iif ( getElementModel ( player ), getElementModel ( player ), "N/A" ) )
			if ( getPlayerTeam ( player ) ) then guiSetText ( aTab1.Team, "فريق : "..getTeamName ( getPlayerTeam ( player ) ) )
			else guiSetText ( aTab1.Team, "الفريق : لايوجد" ) end
			guiSetText ( aTab1.Ping, "البينغ :"..getPlayerPing ( player ) )
			guiSetText ( aTab1.Money, "المال : "..( aPlayers[player]["money"] or 0 ) )
			if ( getElementDimension ( player ) ) then guiSetText ( aTab1.Dimension, "رقم العالم الوهمي : "..getElementDimension ( player ) ) end
			if ( getElementInterior ( player ) ) then guiSetText ( aTab1.Interior, "المبنى : "..getElementInterior ( player ) ) end
			guiSetText ( aTab1.JetPack, iif ( doesPedHaveJetPack ( player ), "إزالة النفاثه", "إعطاء نفاثه" ) )
			if ( getPedWeapon ( player ) ) then guiSetText ( aTab1.Weapon, "سلاح : "..getWeaponNameFromID ( getPedWeapon ( player ) ).." (رقم تعريفي : "..getPedWeapon ( player )..")" ) end
			local x, y, z = getElementPosition ( player )
			guiSetText ( aTab1.Area, "منطقة : "..iif ( getZoneName ( x, y, z, false ) == getZoneName ( x, y, z, true ), getZoneName ( x, y, z, false ), getZoneName ( x, y, z, false ).." ("..getZoneName ( x, y, z, true )..")" ) )
			guiSetText ( aTab1.PositionX, "X: "..x )
			guiSetText ( aTab1.PositionY, "Y: "..y )
			guiSetText ( aTab1.PositionZ, "Z: "..z )
			local vehicle = getPedOccupiedVehicle ( player )
			if ( vehicle ) then
				guiSetText ( aTab1.Vehicle, "المركبه : "..getVehicleName ( vehicle ).." (رقم تعريفي : "..getElementModel ( vehicle )..")" )
				guiSetText ( aTab1.VehicleHealth, "صحة المركبة : "..math.ceil ( getElementHealth ( vehicle ) ).."%" )
			else
				guiSetText ( aTab1.Vehicle, "حالة الاعب : على الاقدام" )
				guiSetText ( aTab1.VehicleHealth, "صحة المركبة : 0%" )
			end
			if ( aPlayers[player]["admin"] ) then
				guiSetText(aTab1.Admin, "سحب الادمنيه")
			else
				guiSetText(aTab1.Admin, "إعطاء الادمنيه")
			end
			return player
		end
	end
...
function aClientSync ( type, table )
	...
	elseif ( type == "server" ) then
		guiSetText ( aTab3.Server, "اسم السيرفر : "..table["name"] )
		guiSetText ( aTab3.Players, "اللاعبين : "..#getElementsByType ( "player" ).."/"..table["players"] )
		guiSetText ( aTab3.Password, "كلمة المرور : "..( table["password"] or "None" ) )
		guiSetText ( aTab3.GameType, "نوع المود : "..( table["game"] or "None" ) )
		guiSetText ( aTab3.MapName, "اسم الخريطة : "..( table["map"] or "None" ) )
		guiSetText ( aTab3.FPSCurrent, "الاف بي اس : "..( table["fps"] or "N/A" ) )
	...
	elseif ( type == "bans" or type == "bansmore" ) then
		...
		guiSetText( aTab4.BansTotal, "ظاهريين  " .. amount .. " / " .. total .. "  المطروديين" )
	...
	elseif ( type == "messages" ) then
		...
		guiSetText ( aTab1.Messages, table["unread"].."/"..table["total"].." الرسائل الغير مقروءة" )
...
function aClientDoubleClick ( button )
	if ( source == aTab1.WeaponOptions ) then
		if ( guiGridListGetSelectedItem ( aTab1.WeaponOptions ) ~= -1 ) then
			...
			guiSetText ( aTab1.GiveWeapon, "يعطى: "..wep.." " )
		end
		guiSetVisible ( aTab1.WeaponOptions, false )
	elseif ( source == aTab1.VehicleOptions ) then
		...
		if ( item ~= -1 ) then
			if ( guiGridListGetItemText ( aTab1.VehicleOptions, item, 1 ) ~= "" ) then
				...
				guiSetText ( aTab1.GiveVehicle, "يعطى: "..guiGridListGetItemText ( aTab1.VehicleOptions, item, 1 ).." " )
			end
		end
		guiSetVisible ( aTab1.VehicleOptions, false )
	...
	if ( button == "left" ) then
		...
		if ( getElementParent ( source ) == aTab1.Tab ) then
			...
			elseif ( getElementType ( source ) == "gui-button" )  then
				...
				if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) == -1 ) then
					aMessageBox ( "خطأ", "لم يتم العثور على اللاعب!" )
				else
					local name = guiGridListGetItemPlayerName ( aTab1.PlayerList, guiGridListGetSelectedItem( aTab1.PlayerList ), 1 )
					local player = getPlayerFromName ( name )
					if ( source == aTab1.Kick ) then aInputBox ( "طرد اللاعب "..name, "اكتب سبب الطرد واضغط انتر", "", "kickPlayer", player )
					...
					elseif ( source == aTab1.Mute ) then if not aPlayers[player]["mute"] then aMuteInputBox ( player ) else aMessageBox ( "تأكيد", "هل انت متاكد من فك الميوت"..name.."?", "unmute", player ) end
					...
					elseif ( source == aTab1.Nick ) then aInputBox ( "تغيير الاسم", "غير اسمه و اضغط انتر", name, "setNick", player )
					elseif ( source == aTab1.Shout ) then aInputBox ( "إرسال كلمه", "اكتب الكلمه او الجمله و اضغط انتر", "", "shout", player )
					elseif ( source == aTab1.SetHealth ) then aInputBox ( "إعطاء دم", "اكتب مقدار الدم و اضغط انتر", "100", "setHealth", player )
					elseif ( source == aTab1.SetArmour ) then aInputBox ( "إعطاء درع", "اكتب قوة الدرع و اضغط انتر", "100", "setArmor", player )
					...
					elseif ( source == aTab1.SetMoney ) then aInputBox ( "اعطاء المال", "اكتب عدد المال و اضغط انتر", "0", "setMoney", player )
					elseif ( source == aTab1.SetStats ) then aPlayerStats ( player )
					elseif ( source == aTab1.SetDimension ) then aInputBox ( "رقم العالم الوهمي", "اكتب رقم العالم الوهمي من 0 الى 65535", "0", "setDimension", player)
					...
					elseif ( source == aTab1.Admin ) then
						if ( aPlayers[player]["admin"] ) then aMessageBox ( "تأكيد", "هل انت متاكد من سحب ادمنية "..name.."?", "revokeAdmin", player )
						else aMessageBox ( "تاكيد", "هل انت متاكد من اعطاءه ادمنيه "..name.."?", "giveAdmin", player ) end
				...
				if ( guiGridListGetSelectedItem( aTab1.PlayerList ) ~= -1 ) then
					...
					if ( player ) then
						...
						if ( ( guiCheckBoxGetSelected ( aTab6.OutputPlayer ) ) and ( player ) ) then
							outputConsole ( "الأسم: "..aPlayers[player]["name"]
										..", الأيبي: "..aPlayers[player]["IP"]
										..", السريال: "..aPlayers[player]["serial"]
									--	..", Community Username: "..aPlayers[player]["username"]
										..", اسم العضويه: "..aPlayers[player]["accountname"]
										..", D3D9.DLL : "..aPlayers[player]["d3d9dll"] )
						end
						guiSetText ( aTab1.IP, "الأيبي: "..aPlayers[player]["IP"] )
						guiSetText ( aTab1.Serial, "السريال: "..aPlayers[player]["serial"] )
						--guiSetText ( aTab1.Username, "Community Username: "..aPlayers[player]["username"] )
						guiSetText ( aTab1.Accountname, "اسم العضويه: "..aPlayers[player]["accountname"] )
						guiSetText ( aTab1.ACDetected, "AC تم الكشف ع: "..aPlayers[player]["acdetected"] )
						guiSetText ( aTab1.ACD3D, "D3D9.DLL: "..aPlayers[player]["d3d9dll"] )
						guiSetText ( aTab1.ACModInfo, "GTA تعديل: "..aPlayers[player]["imgmodsnum"] )
						...
						guiSetText ( aTab1.Version, "الاصدار: " .. ( aPlayers[player]["version"] or "" ) )
					end
				else
					guiSetText ( aTab1.Name, "الأسم : غير معروف" )
					guiSetText ( aTab1.IP, "الأيبي : غير معروف" )
					guiSetText ( aTab1.Serial, "السريال : غير معروف" )
					--guiSetText ( aTab1.Username, "Community Username: N/A" )
					guiSetText ( aTab1.Version, "الاصدار : غير معروف" )
					guiSetText ( aTab1.Accountname, "اسم العضويه : غير معروف" )
					guiSetText ( aTab1.Groups, "المجموعه : غير معروف" )
					guiSetText ( aTab1.ACDetected, "AC تم الكشف عنها : غير معروف" )
					guiSetText ( aTab1.ACD3D, "D3D9.DLL : غير معروف" )
					guiSetText ( aTab1.ACModInfo, "GTA تعديل : غير معروف" )
					guiSetText ( aTab1.Mute, "اسكات" )
					guiSetText ( aTab1.Freeze, "تجميد" )
					guiSetText ( aTab1.Admin, "إعطاءه ادمنيه" )
					guiSetText ( aTab1.Health, "الدم: 0%" )
					guiSetText ( aTab1.Armour, "الدرع: 0%" )
					guiSetText ( aTab1.Skin, "الشخصيه : غير معروف" )
					guiSetText ( aTab1.Team, "الفريق : لايوجد" )
					guiSetText ( aTab1.Ping, "البينغ : 0" )
					guiSetText ( aTab1.Money, "المال : 0" )
					guiSetText ( aTab1.Dimension, "رقم العالم الوهمي : 0" )
					guiSetText ( aTab1.Interior, "المبنى : 0" )
					guiSetText ( aTab1.JetPack, "إعطاءه نفاثه" )
					guiSetText ( aTab1.Weapon, "سلاح : غير معروف" )
					guiSetText ( aTab1.Area, "منطقة : غير معروف" )
					guiSetText ( aTab1.PositionX, "X: 0" )
					guiSetText ( aTab1.PositionY, "Y: 0" )
					guiSetText ( aTab1.PositionZ, "Z: 0" )
					guiSetText ( aTab1.Vehicle, "المركبة : غير معروف" )
					guiSetText ( aTab1.VehicleHealth, "قوة المركبة : 0%" )
		...
		elseif ( getElementParent ( source ) == aTab2.Tab ) then
			...
			elseif ( ( source == aTab2.ResourceStart ) or ( source == aTab2.ResourceRestart ) or ( source == aTab2.ResourceStop ) or ( source == aTab2.ResourceDelete ) or ( source == aTab2.ResourceSettings ) ) then
				if ( guiGridListGetSelectedItem ( aTab2.ResourceList ) == -1 ) then
					aMessageBox ( "تنبيه", "المرجوا اختيار المود المراد تعديله" )
				else
					...
					elseif ( source == aTab2.ResourceDelete ) then aMessageBox ( "تحذير", "هل انت متاكد من انك تريد تعطيل و حذف هذا المود '" .. guiGridListGetItemText ( aTab2.ResourceList, guiGridListGetSelectedItem( aTab2.ResourceList ), 1 ) .. "' ?", "stopDelete", guiGridListGetItemText ( aTab2.ResourceList, guiGridListGetSelectedItem( aTab2.ResourceList ), 1 ) )
			...
			elseif ( source == aTab2.ResourcesStopAll ) then aMessageBox ( "تحذير", "هل انت متاكد من انك تريد تعطيل جميع المودات ? هذا قد يشمل ايضا تعطيل مود 'admin' ", "stopAll" )
			elseif ( source == aTab2.ResourceList ) then
				guiSetVisible ( aTab2.ResourceFailture, false )
				if ( guiGridListGetSelectedItem ( aTab2.ResourceList ) ~= -1 ) then
					guiSetText(aTab2.ResourceName, "الاسم الكامل : " .. guiGridListGetItemText(aTab2.ResourceList, guiGridListGetSelectedItem ( aTab2.ResourceList ), 4))
					guiSetText(aTab2.ResourceAuthor, "المالك : " .. guiGridListGetItemText(aTab2.ResourceList, guiGridListGetSelectedItem ( aTab2.ResourceList ), 5))
					guiSetText(aTab2.ResourceVersion, "النسخة : " .. guiGridListGetItemText(aTab2.ResourceList, guiGridListGetSelectedItem ( aTab2.ResourceList ), 6))
		...
		elseif ( getElementParent ( source ) == aTab3.Tab ) then
			if ( source == aTab3.SetGameType ) then aInputBox ( "اسم المود", "اكتب اسم المود واضغط انتر:", "", "setGameType" )
			elseif ( source == aTab3.SetMapName ) then aInputBox ( "اسم الخريطة", "اكتب اسم الخريطة واضغط انتر:", "", "setMapName" )
			elseif ( source == aTab3.SetWelcome ) then aInputBox ( "رسالة الترحيب", "اكتب رسالة الترحيب واضغط انتر:", "", "setWelcome" )
			elseif ( source == aTab3.SetPassword ) then aInputBox ( "كلمة مرور السيرفر", "اكتب كلمة مرور واضغط انتر:", "", "setServerPassword" )
			elseif ( source == aTab3.Shutdown ) then aInputBox ( "اطفئ السيرفر", "اكتب كلمة مرور واضغط انتر:", "", "serverShutdown" )
		...
		elseif ( getElementParent ( source ) == aTab4.Tab ) then
			if ( source == aTab4.Details ) then
				if ( guiGridListGetSelectedItem ( aTab4.BansList ) == -1 ) then
					aMessageBox ( "تنبيه", "خطأ , المرجوا اختيار لاعب المراد تفقد معلوماته" )
				else
			...
			elseif ( source == aTab4.Unban ) then
				if ( guiGridListGetSelectedItem ( aTab4.BansList ) == -1 ) then
					aMessageBox ( "تنبيه", "خطأ , المرجوا اختيار لاعب المراد رفع الحظر عنه" )
				else
					local selip = guiGridListGetItemText ( aTab4.BansList, guiGridListGetSelectedItem( aTab4.BansList ), 2 )
					local selserial = guiGridListGetItemText ( aTab4.BansList, guiGridListGetSelectedItem( aTab4.BansList ), 3 )
					if ( aBans["Serial"][selserial] ) then aMessageBox ( "تنبيه", "هل تريد فك الحظر عن "..selserial.." ? ", "unbanSerial", selserial )
					else aMessageBox ( "question", "Unban IP "..selip.."?", "unbanIP", selip ) end
				end
			elseif ( source == aTab4.UnbanIP ) then
				aInputBox ( "فك الحظر اي بي", "ادخل الاي بي المراد فك الحظر عنه", "", "unbanIP" )
			elseif ( source == aTab4.UnbanSerial ) then
				aInputBox ( "فك الحظر سيريال", "ادخل سيريال المراد فك الحظر عنه", "", "unbanSerial" )
			elseif ( source == aTab4.BanIP ) then
				aInputBox ( "الحظر الاي بي", "ادخل الاي بي المراد حظره", "", "banIP")
			elseif ( source == aTab4.BanSerial ) then
				aInputBox ( "الحظر سيريال", "ادخل سيريال المراد حظره", "", "banSerial" )
		...
		elseif ( getElementParent ( source ) == aTab6.Tab ) then
			...
			elseif ( source == aTab6.PasswordChange ) then
				...
				if ( passwordNew == "" ) then aMessageBox ( "خطأ", "اكتب كلمة المرور الجديده" )
				elseif ( passwordConf == "" ) then aMessageBox ( "خطأ", "كرر كلمة المرور الجديده" )
				elseif ( string.len ( passwordNew ) < 4 ) then aMessageBox ( "خطأ", "يجب أن تكون كلمة السر الجديدة لا تقل عن 4 حروف" )
				elseif ( passwordNew ~= passwordConf ) then aMessageBox ( "خطأ", "كلمة المرور المكرره لاتطابق الجديده" )
				else triggerServerEvent ( "aAdmin", localPlayer, "كلمة المرور", guiGetText ( aTab6.PasswordOld ), passwordNew, passwordConf ) end
			end
		end
	elseif ( button == "right" ) then
		if ( source == aTab1.GiveWeapon ) then aInputBox ( "ذخيرة السلاح", "القيم العددية المقبولة من 1 ل 9999 فقط *", "100", "setCurrentAmmo" )
		end
	end
end
...
function aClientRender ()
	if ( guiGetVisible ( aAdminForm ) ) then
		if ( getTickCount() >= aLastCheck ) then
			aAdminRefresh ()
			local th, tm = getTime()
			guiSetText ( aTab3.Players, "اللاعبين: "..#getElementsByType ( "player" ).."/"..gettok ( guiGetText ( aTab3.Players ), 2, 47 ) )
			guiSetText ( aTab3.TimeCurrent,	string.format("الوقت: %02d:%02d", th, tm ) )
			guiSetText ( aTab3.GravityCurrent, "الجاذبيه: "..string.sub ( getGravity(), 0, 6 ) )
			guiSetText ( aTab3.SpeedCurrent, "سرعة اللعب: "..getGameSpeed() )
			guiSetText ( aTab3.WeatherCurrent, "الجو: "..getWeather().." ("..getWeatherNameFromID ( getWeather() )..")" )
