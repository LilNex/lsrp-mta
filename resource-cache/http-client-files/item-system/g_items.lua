g_items = {
	...
	[93] = { "Doliprane", "For Your Health", 1, 2222, 0, 0, 0, 0.1, weight = 0.4 },
	...
	[102] = { "Aspro", "For Your Health", 1, 1271, 0, 0, 0, 0.1, weight = 0.4 },

	[103] = { "Shelf", "A large shelf to store stuff on", 4, 3761, -0.15, 0, 85, 1.95, weight = 0.5 --[[admins onleh]] },
	...
	[155] = { "Driver's License - Truck", "A Los Santos driving license.", 10, 1581, 270, 270, 0, 0, weight = 0.1 },
    ...
    [183] = { "A Passeport", "To Travel Out City (LS,LV,SF)", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, --  Chase
	...
	[214] = { "Orale Rinse", "this for remove dug addiction", 3, 1576, 0, 0, 0, 0.07, weight = 0.1}, -- Chaos

	[215] = { "Trafiquer", "Tool to steal cars", 3, 1576, 0, 0, 0, 0.07, weight = 0.1}, -- Trafiquer

	[216] = { "Trash", "Just A Scavenger ", 3, 1264, 0, 0, 0, 0.40, weight = 0.1}, -- Trafiquer 0.07
	...
	[270] = { "Maroc Telecom Sim 4G", "Sim can be used to run your phone.", 7, 330, 90, 90, 0, 0, weight = 0.3 }, -- UndR

	[271] = { "Inwi Sim 4G", "Sim can be used to run your phone.", 7, 330, 90, 90, 0, 0, weight = 0.3 }, -- UndR

	[272] = { "Orange Sim 4G", "Sim can be used to run your phone.", 7, 330, 90, 90, 0, 0, weight = 0.3 }, -- UndR

	[273] = { "Generic Fish", "#v", 4, 1604, 0, 90, 0, 0.07, weight = 0.1, preventSpawn = true},
	
	[276] = { "Cannabis Seed", "Seed can be used to plant Weed and recolt it.", 3, 1279, 0, 0, 0, 0, weight = 0.1 },  

	[277] = { "Cannabis", "Can be used to feel high and dream way more.", 3, 1279, 0, 0, 0, 0, weight = 0.1 },

	[278] = { "Planting Pot", "Can be used to plant something you want.", 3, 1279, 0, 0, 0, 0, weight = 0.1 },
	...
	[300] = { "Dirty Money", "Money from illegal activities", 10, 1550, 0, 0, 0, 0.04, weight = 0.3 },

	[310] = { "Grape", "A fruit.", 1, 916, 205, 205, 0, 0.06, weight = 0.5 },

	[400] = { "Bandage", "Used to heal yourself", 4, 1550, 0, 0, 0, 0.04, weight = 0.3 },

	[401] = { "Kevlar", "Body armor , hidden and protective.", 6, 1581, 270, 270, 0, 0, weight = 2 },

	[402] = { "Swing Kit", "Item used to give ropes.", 4, 1550, 0, 0, 0, 0.04, weight = 0.3 },

	[403] = { "Leather", "From animals.", 4, 1550, 0, 0, 0, 0.04, weight = 0.3 },

	[404] = { "ATM Cracker", "Used to rob the atm's", 6, 2386, 0, 0, 0, 0.1, weight = 1 },

	[405] = { "Repair Kit", "Able to repair your vehicule", 6, 2386, 0, 0, 0, 0.1, weight = 1 },

	[450] = { "Lockpick", "Used to unlock vehicles", 4, 2386, 0, 0, 0, 0.1, weight = 1 },





	[501] = { "Woods Logs", "Woods Logs", 4, 1463, 0, 0, 0, 0.04, weight = 1 }, -- LilNex

	[502] = { "Woods Planks", "Used to craft objects", 4, 1224, 0, 0, 0, 0.04, weight = 0.5 }, -- LilNex

	[505] = { "Axe", "Tool for cut trees", 4, 333, 0, 0, 0, 0.04, weight = 0.5 }, -- LilNex

	[506] = { "Minerals", "Minerals", 4, 3930, 0, 0, 0, 0.04, weight = 1 }, -- LilNex

	[507] = { "Iron Ingot", "Can be used to craft a lot of things !", 4, 2040, 0, 0, 0, 0.04, weight = 0.5 }, -- LilNex

	[510] = { "PickAxe", "Tool for mining", 4, 2040, 0, 0, 0, 0.04, weight = 0.5 }, -- LilNex

	[515] = { "Shovel", "To collect garbage !", 4, 337, 0, 0, 0, 0.04, weight = 1 }, -- LilNex

	[516] = { "Plastic", "Can be used to craft a lot of things !", 4, 1619, 0, 0, 0, 0.04, weight = 0.3 }, -- LilNex

	[520] = { "Sand", "Sand !", 4, 1985, 0, 0, 0, 0.04, weight = 1 }, -- LilNex

	[521] = { "Glass", "Can be used to craft a lot of things !", 4, 1649, 0, 0, 0, 0.04, weight = 0.3 }, -- LilNex

	[550] = { "Gate Cracker", "Used to open any gate remotly", 4, 2386, 0, 0, 0, 0.1, weight = 1 },
	[551] = { "Pseudoephedrine", "For advanced chirurgical.", 3, 1576, 0, 0, 0, 0.07, weight = 0.5 },
	[552] = { "Ammonium Chloride", "For advanced chimics.", 3, 1576, 0, 0, 0, 0.07, weight = 0.5 },
	[553] = { "Sulfamic Acid", "Sulfamic Acid, when mixed can create some strong drugs.", 3, 1279, 0, 0, 0, 0, weight = 0.1 },
	[555] = { "Methamphetamine", "A crystal-like substance with strong energy kicking effects.", 3, 1580, 0, 0, 0, 0, weight = 0.1 },

	[570] = { "Tube Furnance", "A chemistry set.", 4, 1210, 90, 0, 0, 0.1, weight = 2 },
	[571] = { "Chemistry Tubes", "A chemistry set.", 4, 1210, 90, 0, 0, 0.1, weight = 2 },
	[572] = { "Catalyser", "A chemistry set.", 4, 1210, 90, 0, 0, 0.1, weight = 2 },
	[600] = { "LS Food Badge", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 },

	[601] = { "Sanders Auto-Service Badge", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 },

	[602] = { "LS Cleaners Badge", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.5 },

	[650] = { "Jawaz Tal9i7", "Pass Vaccinal", 4, 1581, 0, 0, 0, 0.04, weight = 0.1 }, -- LilNex
	...
	[10001] = { "Mariguana", "Transform It To Some Packet Of Mariguana", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10002] = { "Pack Of Mariguana", "Use it With a Paper To Get A joint", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10003] = { "Joint Paper", "Use it With a Pack Of Mariguana To Get A joint", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10004] = { "Piece Of Iron", "small Piece of iron", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10005] = { "Piece Of Wood", "a piece of wood", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10006] = { "Colt 45 Piece 1 (Canon)", "a piece of colt45", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10007] = { "Colt 45 Piece 2 ", "a piece of colt45", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	
    [10077] = { "Colt 45 Piece 5(Cross)", "a piece of colt45", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	


    [10008] = { "Colt 45 Piece 3", "a piece of colt45", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10009] = { "Colt 45 Piece 4", "a piece of colt45", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10010] = { "Mariguana Knife", "this is ussed to make some pieces of Mariguana", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},			

    [10011] = { "Cannel", "this for crafting Orale Rinse", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10012] = { "Spoon", "A small Spoon", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10013] = { "Poivre", "this for crafting Orale Rinse", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10014] = { "Cardamone", "this for crafting Orale Rinse", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

   

    [10015] = { "Powder", "this for crafting Medkit", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},			

    [10016] = { "Aspirins", "this for crafting Medkit", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10017] = { "Chile", "this for crafting Medkit", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10018] = { "Capsule", "this for crafting Medkit", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    [10019] = { "Medkit", "a Medkit For health care", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

    

	--[10020] = { "Crowbar", " this tool give you the ability to break Vehicle Doors", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10021] = { "Elctro Cable", " this tool give you the ability to start Vehicle Engine", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

	

	[10022] = { "Wood", "Naturel Wood", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},	

	

    [10023] = { "Dress", "A piece of dress", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10024] = { "Thread", "a Thread", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},
    [10025] = { "Fishing Membership", "This Card can give you access to fish and rent boats", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},

    [10026] = { "Doud", "Doud can use on fish road and imkn ikon f krk hh", 3, 1576, 0, 0, 0, 0.07, weight = 0.1},
...
function getBadges( )
	...
	return {
		...
		[112]  = { "SAHP badge", 		"a SAHP badge",			{[102] = true},				 	{222, 184, 135, true},	2}, -- Sheriff department

		[65]  = { "LSFD badge", 		"a LSFD badge", {[2] = true},	    {175,50,50},	1},

		[86]  = { "LSN badge",		"an LSN ID",				{[20] = true},					{150,150,255},	1},

		-- [86]  = { "FBI Badge",		"a FBI Badge",				{[5] = true},					{150,150,255},	1},


		-- [87]  = { "GOV badge",		"a Government badge",		{[3] = true},					{0, 80, 0},	1},

		[602]  = { "Cleaners badge",		"a Cleaners badge",		{[91] = true},					{0, 150, 0},	1},
		...
		[600] = { "LS Foods ID", "An ID from LS Foods", {[100] = true},  {255, 102, 0}, 1}, -- anumaz, Cargo Group ID
		[601] = { "Sanders Auto-Service ID", "An ID from LS Foods", {[94] = true},  {220,0,255}, 1}, -- anumaz, Cargo Group ID
		...
		-- [131] = { "LSCSD badge",        "an LSCSD badge",                {[15] = true},                    {210, 180, 140},    1}, -- Adams added the LSCSD badge / 03/02/14
