local allowedFactions = {
	[47]=true,	--Los Santos International Airport
}
...
function canPlayerControlGates()
	local faction = tonumber(getElementData(getLocalPlayer(), "faction"))
	if(allowedFactions[faction] or exports.integration:isPlayerTrialAdmin(thePlayer) and getElementData(thePlayer, "duty_admin") == 1) then
		return true
	end
