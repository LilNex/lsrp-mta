...
blackFemales = {304, 298, 10, 11, 12, 13, 40, 41, 63, 64, 69, 76, 91, 139, 148, 190, 195, 207, 215, 218, 219, 238, 243, 244, 256, 304 }



whiteFemales = {12, 31, 38, 39, 40, 41, 53, 54, 55, 56, 64, 75, 85, 87, 88, 89, 90, 91, 92, 93, 129, 130, 131, 138, 140, 145, 150, 151, 152, 157, 172, 178, 192, 193, 194, 196, 197, 198, 199, 201, 205, 211, 214, 216, 224, 225, 226, 231, 232, 233, 237, 243, 246, 251, 257, 263, 298 }
...
g_shops = {
	...
	{ -- 1
...

		{
			...
			{ name = "Spray Can", description = "Hey, you better not tag with this punk!", price = 10000, itemID = 115, itemValue = 41 },
			...
			{ name = "Mask", description = "A ski mask.", price = 3000, itemID = 56 },
			...
			{ name = "Pack of cigaretttes", description = "Things you can smoke...", price = 10, itemID = 105, itemValue = 20, minimum_age = 18 },

			{ name = "OCB Slim", description = "Transparent rolling papers. Pack contains 20 papers.", price = 50, itemID = 181, itemValue = 20, minimum_age = 18 },

			{ name = "Lighters", description = "To light up your addiction, a geuine Zippo!", price = 45, itemID = 107 },
			{ name = "Repair Kit", description = "Able to repair your vehicule", price = 3000, itemID = 405 },



			-- { name = "Knife", description = "To help ya out in the kitchen.", price = 80, itemID = 115, itemValue = 4 },
	...
	{ -- 3
...

		{
			...
			{ name = "Sandwich", description = "A yummy sandwich with cheese", price = 50, itemID = 8 },



			{ name = "Taco", description = "A greasy mexican taco", price = 50, itemID = 11 },



			{ name = "Burger", description = "A double cheeseburger with bacon", price = 52, itemID = 12 },



			{ name = "Donut", description = "Hot sticky sugar covered donut", price = 60, itemID = 13 },



			{ name = "Cookie", description = "A luxury chocolate chip cookie", price = 30, itemID = 14 },



			{ name = "Hotdog", description = "Nice, tasty hotdog!", price = 45, itemID = 1 },



			{ name = "Pancake", description = "Yummy, a pancake!!", price = 50, itemID = 108 },
...

		{
			...
			{ name = "Softdrink", description = "A cold can of Sprunk.", price = 45, itemID = 9 },



			{ name = "Water", description = "A bottle of mineral water.", price = 50, itemID = 15 },
	...
	{ -- 8
...

		{
			...
			name = "Electronics",
                        ...
                        { name = "Maroc Telecome Sim 4G", description = "Can be used to run a phone.", price = 150, itemID = 270 },



                        { name = "Inwi Sim 4G", description = "Can be used to run a phone.", price = 150, itemID = 271 },



                        { name = "Orange Sim 4G", description = "Can be used to run a phone.", price = 150, itemID = 272 },
			...
			{ name = "Macbook pro A1286 Core i7", description = "A top of the range Macbook to view e-mails and browse the internet.", price = 1500, itemID = 96 },
			...
			{ name = "Vehicle Alarm System", description = "Protect your vehicle with an alarm.", price = 800, itemID = 130 },



			--{ name = "Flashlight", description = "Lights up the environment.", price = 24, itemID = 145 }, -- Disabled by Adams
	...
	{ -- 9
...

		{
			...
			{ name = "Ziebrand Beer", description = "The finest beer, imported from Holland.", price = 100, itemID = 58, minimum_age = 21 },



			{ name = "Bastradov Vodka", description = "For your best friends - Bastradov Vodka.", price = 250, itemID = 62, minimum_age = 21 },



			{ name = "Scottish Whiskey", description = "The Best Scottish Whiskey, now exclusively made from Haggis.", price = 250, itemID = 63, minimum_age = 21 },
	...
	{ -- 12
		...
		description = "All what you need for jobs !",
...

		{
			...
			{ name = "Quatorza", description = "For job dl7am.", price = 4000, itemID = 115, itemValue = 2 },
			{ name = "Axe", description = "Bach t9t3 l3oud.", price = 1000, itemID = 505},
			{ name = "Pickaxe", description = "Bach tmini l minerals.", price = 1500, itemID = 510},
			{ name = "Shovel", description = "Bach tjm3 trash.", price = 800, itemID = 515},
			--{ name = "Shovel", description = "Bach tjm3 trash.", price = 800, itemID = 515},
			{ name = "Leather", description = "Bach tcrafti bandage (only LSFD)", price = 200, itemID = 403},
			{ name = "Workbench", description = "A Workbench to craft a lot of things !", price = 5000, itemID = 242},
			{ name = "Shelf", description = "A large shelf to store stuff on", price = 5000, itemID = 103},
	...
	{ -- 20
...

		{
			...
			{ name = "Marijuana Seeds", description = "A seed with a big potential.", price = 20, itemID = 276 },

			{ name = "Cocaine Alkaloid", description = "Can be planted.", price = 40, itemID = 31 },
	...
	{ -- 21
...

		{
			...
			{ name = "Donut", description = "Hot sticky sugar covered donut", price = 10, itemID = 13 },


			{ name = "Burger", description = "A Double cheese burger", price = 10, itemID = 12 },



			{ name = "Cookie", description = "A luxuty chocolate chip cookie", price = 10, itemID = 14 },
...

		{
			...
			{ name = "Coffee", description = "A small cup of coffee.", price = 8, itemID = 83, itemValue = 2 },



			{ name = "Softdrink", description = "A cold can of Sprunk.", price = 8, itemID = 9, itemValue = 3 },



			{ name = "Water", description = "A bottle of mineral water.", price = 8, itemID = 15, itemValue = 2 },
...

	{
		...
		{ name = "Pseudoephedrine", description = "A pills for a rare case.", price = 500, itemID = 50 },

		{ name = "Sulfamic acid", description = "A liquid used in chimics.", price = 400, itemID = 100 },
